...
alert_template = {
    ...
    'location': 'xcyber360-X',
}

options_template = {'pretext': 'Xcyber360-X -- Alert generated', 'author_name': 'The amazing Xcyber360', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Xcyber360-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "xcyber360-X", "author_name": "The amazing Xcyber360",'
    '"footer": "Slack API"}'
)
slack_webhook = ''
