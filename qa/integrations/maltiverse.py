...
This integration enrichs any alert generated by Xcyber360 via the Maltiverse API,
...
And restart Xcyber360 Manager:

    /etc/init.d/xcyber360-manager restart
...
#    5 - Invalid URL
#    6 - Unable to connect to Xcyber360
#    7 - Unexpected error sending message to Xcyber360
...
def process_args(args: list):
    ...
    # Xcyber360 Manager in case of positive match
...
def send_event(msg: str, agent: dict = None):
    """Send an event to the Xcyber360 Manager.
    ...
    try:
        ...
        if e.errno == 111:
            print('ERROR: Xcyber360 is not running.')
            sys.exit(6)
        elif e.errno == 90:
            print('ERROR: Message too long to send to Xcyber360.')
            sys.exit(7)
