"""
Module to wrapp the Xcyber360 API responses. This modules contains the following:

- Xcyber360APIResponse
"""
from http import HTTPStatus
from json import JSONDecodeError


class Xcyber360APIResponse:
    """Wrapper class to handle Xcyber360 API responses.
    ...
    Attributes:
        ...
        error (int): Xcyber360 API response error.
        data (dict|str): Xcyber360 API response data in dict format if possible else string.
    """
    ...
    def __get_data(self):
        ...
        Returns:
            (dict|str):  Xcyber360 API response data in dict format if possible else string.
        """
