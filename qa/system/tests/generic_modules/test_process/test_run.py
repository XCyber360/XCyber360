...
from xcyber360_qa_framework.generic_modules.process.windows_process import WindowsProcess
from xcyber360_qa_framework.generic_modules.process.linux_process import LinuxProcess
