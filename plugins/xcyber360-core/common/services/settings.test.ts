...
describe('[settings] Methods', () => {
  ...
  //     ${true}              | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Xcyber360, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${'Custom footer'}        | ${'Copyright © 2023 Xcyber360, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Xcyber360, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Xcyber360, Inc.'}
  //     ${true}              | ${'customization.reports.header'} | ${'Custom header'}        | ${'Custom header'}
  //     ${true}              | ${'customization.reports.header'} | ${''}                     | ${'info@xcyber360.com\nhttps://xcyber360.com'}
  //     ${false}             | ${'customization.reports.header'} | ${'Custom header'}        | ${'info@xcyber360.com\nhttps://xcyber360.com'}
  //     ${false}             | ${'customization.reports.header'} | ${''}                     | ${'info@xcyber360.com\nhttps://xcyber360.com'}
  //   `(
