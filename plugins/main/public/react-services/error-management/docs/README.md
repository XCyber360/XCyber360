...
- Xcyber360 API errors
- Indexer Error
- Http errors
- Etc


Our frontend server-side have a intermedial layer between the frontend and the backend APIs like Indexer and Xcyber360.
This layer catch the error and categorize them by type and add a custom error code.

 ### Error codes: code
 * xcyber360-api-Indexer 20XX
 * xcyber360-api         30XX
 * xcyber360-Indexer     40XX
 * xcyber360-reporting   50XX
 * unknown           1000
...
graph TD;
 ...
 ErrorFactory-->Xcyber360ApiError
 ErrorFactory-->Xcyber360ReportingError
...
For more details about the error orchestrator see the [Error Orchestrator documentation](https://github.com/XCyber360/XCyber360/tree/master/dashboard/plugins/blob/ef071e55fd310bdb4cecb7d490ea83372bb07b01/public/react-services/error-orchestrator/README.md)
...
class iXcyber360Error {
    <<interface>>
    +Error error
    +IXcyber360ErrorLogOptions logOptions
}

iXcyber360Error <|-- Xcyber360Error : implements
Xcyber360Error <|-- HttpError : extends
HttpError <|-- Xcyber360ApiError : extends
HttpError <|-- Xcyber360ReportingError : extends
...
|---------------------|-------------|-------|---------|
| Xcyber360ApiError       | toast       |       |    ✅   |
| Xcyber360ReportingError | toast       |       |    ✅   |
