...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Xcyber360 dashboard email template</title>
  ...
  <body>
    <span class="preheader"
      >A new Xcyber360 Dashboards report is available &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              ...
              <tr>
                <td class="wrapper">
                  ...
                  >
                    <tr>
                      <td class="brand">
                        <h1>Xcyber360 dashboards reports</h1>
                      </td>
                    </tr>
                    <tr>
                      <td class="kpi">
                            ...
                            <td>
                              ...
                              <p>
                                <a id="report_name" href="{{urlDefinition}}"
                                  >{{REPORT NAME}}</a
                                >
                                is now available in Xcyber360 Dashboards.
                              </p>
                            </td>
                          </tr>
                        </table>
                            ...
                            <tr>
                              ...
                              <td>
                                <a
                                  ...
                                  href="{{urlDefinition}}"
                                  target="_blank"
                                  >Open in Xcyber360 Dashboards Reports</a
                                >
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <tr>
                      <td class="footer">
                        <p>
                          Is the ‘Open in Xcyber360 Dashboards Reports’ button not
                    ...
                    <tr>
                      <td class="footer">
                        <p>
                          ...
                          the report sender or the administrator of your Xcyber360.
                        </p>
                      </td>
                    </tr>
                  </table>
