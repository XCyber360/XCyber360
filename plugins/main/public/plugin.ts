...
import {
  ...
  setWzMainParams,
  setWzCurrentAppID,
  setXcyber360CheckUpdatesPlugin,
  setHeaderActionMenuMounter,
  setXcyber360CorePlugin,
  setXcyber360EnginePlugin,
  setXcyber360FleetPlugin,
} from './kibana-services';
import { validate as validateNodeCronInterval } from 'node-cron';
import {
  AppPluginStartDependencies,
  Xcyber360Setup,
  Xcyber360SetupPlugins,
  Xcyber360Start,
  Xcyber360StartPlugins,
} from './types';
...
export class Xcyber360Plugin
  implements
    Plugin<Xcyber360Setup, Xcyber360Start, Xcyber360SetupPlugins, Xcyber360StartPlugins>
{
  constructor(private readonly initializerContext: PluginInitializerContext) {}
  private hideTelemetryBanner?: () => void;
  public async setup(
    core: CoreSetup,
    plugins: Xcyber360SetupPlugins,
  ): Promise<Xcyber360Setup> {
      ...
      core.application.register({
        ...
        mount: async (params: AppMountParameters) => {
          try {
            ...
            not be loaded
            */
            const setting = plugins.xcyber360Core.configuration._settings.get(
  ...
  public start(
    ...
    setErrorOrchestrator(ErrorOrchestratorService);
    setXcyber360CheckUpdatesPlugin(plugins.xcyber360CheckUpdates);
    setXcyber360CorePlugin(plugins.xcyber360Core);
    setXcyber360EnginePlugin(plugins.xcyber360Engine);
    setXcyber360FleetPlugin(plugins.xcyber360Fleet);
    return {};
  }
}
