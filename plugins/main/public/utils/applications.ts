...
Xcyber360:
Home: 0
Explore (added to Xcyber360 dashboard default categories): 100
...
Indexer management (added to Xcyber360 dashboard default categories): 9000
*/
...
export const devTools = {
  ...
  showInOverviewApp: false,
  showInAgentMenu: false,
  redirectTo: () => '/xcyber360-dev?tab=devTools',
};
...
export const rulesetTest = {
  ...
  showInOverviewApp: false,
  showInAgentMenu: false,
  redirectTo: () => '/xcyber360-dev?tab=logtest',
};
