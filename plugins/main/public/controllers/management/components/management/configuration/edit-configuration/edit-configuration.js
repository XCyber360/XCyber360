/*
 * Xcyber360 app - React component for show Edit configuration.
...
import WzXcyber360APINotReachable from '../util-components/wz-api-not-reachable';
...
class WzEditConfiguration extends Component {
  ...
  async confirmRestart() {
    try {
      ...
      await restartNodeSelected(this.props.clusterNodeSelected, this.props.updateXcyber360NotReadyYet);
      this.props.updateXcyber360NotReadyYet('');
...
const mapDispatchToProps = (dispatch) => ({
  ...
  updateXcyber360NotReadyYet: (value) => dispatch(updateXcyber360NotReadyYet(value)),
});

WzEditConfiguration.propTypes = {
  xcyber360NotReadyYet: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]),
  updateXcyber360NotReadyYet: PropTypes.func,
};
            ...
            <Fragment>
              ...
              {typeof editorValue === 'string' && (
                <WzCodeEditor
                  ...
                  minusHeight={xcyber360NotReadyYet || infoChangesAfterRestart ? 320 : 270}
                />
              )}
            </Fragment>
          ) : (
            <WzXcyber360APINotReachable error={this.props.errorXMLFetched} />
          )}
        </Fragment>
      );
    }
