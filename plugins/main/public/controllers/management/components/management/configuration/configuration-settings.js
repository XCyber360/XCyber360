/*
 * Xcyber360 app - Definitions of configuration sections.
...
import { XCYBER360_MODULES_ID } from '../../../../../../common/constants';
  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        goto: 'open-scap',
        when: agent => hasAgentSupportModule(agent, XCYBER360_MODULES_ID.OPEN_SCAP),
      },
      {
        name: 'CIS-CAT',
        description:
  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        when: agent => hasAgentSupportModule(agent, XCYBER360_MODULES_ID.DOCKER),
      },
    ],
  },
  {
