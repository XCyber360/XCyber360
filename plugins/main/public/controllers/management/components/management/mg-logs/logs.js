/*
 * Xcyber360 app - Component what renders Management/Logs
...
export default compose(
  ...
  class WzLogs extends Component {
    ...
    /**
     * Returns an object with the path to request Xcyber360 logs, the list of nodes and the current selected node.
     */
    async getLogsPath() {
      try {
