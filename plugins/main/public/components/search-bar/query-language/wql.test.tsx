...
describe('Query language - WQL', () => {
  ...
  */
  ...
  // Validate the tokens
  // Some examples of value tokens are based on this API test: https://github.com/xcyber360/xcyber360/blob/813595cf58d753c1066c3e7c2018dbb4708df088/framework/xcyber360/core/tests/test_utils.py#L987-L1050
  it.each`
    WQL                                               | validationError
    ${''}                                             | ${undefined}
    ${'field1'}                                       | ${undefined}
