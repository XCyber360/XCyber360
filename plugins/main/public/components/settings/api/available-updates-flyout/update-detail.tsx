...
import { Update } from '../../../../../../xcyber360-check-updates/common/types';
...
export const UpdateDetail = ({ update, type }: UpdateDetailProps) => {
  ...
  const releaseNotesUrl = hasVersions
    ? `https://documentation.xcyber360.com/current/release-notes/release-${semver.major}-${semver.minor}-${semver.patch}.html`
    : undefined;
  const upgradeGuideUrl = hasVersions
    ? `https://documentation.xcyber360.com/${minorVersion}/upgrade-guide/index.html`
    : undefined;
            ...
            listItems={[
              {
                title: 'Published',
                description:
                  getXcyber360CorePlugin().utils.formatUIDate(published_date),
              },
            ]}
          />
          <EuiSpacer />
