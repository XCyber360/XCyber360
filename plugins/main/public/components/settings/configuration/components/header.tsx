...
import { PLUGIN_PLATFORM_XCYBER360_DOCUMENTATION_URL_PATH_APP_CONFIGURATION } from '../../../../../common/constants';
          ...
          <EuiToolTip position='right' content='More about configuration'>
            <EuiButtonIcon
              ...
              href={webDocumentationLink(
                PLUGIN_PLATFORM_XCYBER360_DOCUMENTATION_URL_PATH_APP_CONFIGURATION,
              )}
            ></EuiButtonIcon>
          </EuiToolTip>
        </h2>
  ...
  return (
    <EuiFlexItem grow={false}>
      <EuiText color='subdued' style={{ paddingBottom: '15px' }}>
        ...
        {getXcyber360CorePlugin().configuration.store.file}
      </EuiText>
    </EuiFlexItem>
  );
};
