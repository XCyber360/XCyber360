...
export const TEST_CASES: tQITestCases = {
  ...
  'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2': {
    queryStringFilter: 'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
        operator: '=',
        value: 'xcyber360-manager-master-v4.3.4-rc1-7.10.2',
      },
    ],
  },
  'and manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
      ...
      },
      {
        ...
        field: 'manager',
        operator: '=',
        value: 'xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another',
      },
    ],
  },
  'and manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
  ...
  'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: 'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2;another=value',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
  ...
  'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: 'manager=xcyber360-manager-master-v4.3.4-rc1-7.10.2 and another',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
