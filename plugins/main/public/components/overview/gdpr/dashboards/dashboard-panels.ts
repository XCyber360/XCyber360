...
const getVisStateTopAgentsByAlertsCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GDPR-Agents',
...
const getVisStateRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GDPR-requirements',
...
const getVisStateRequirementsOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GDPR-Requirements-heatmap',
...
const getVisStateRequirementsHeatmap = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GDPR-Requirements-Agents-heatmap',
    title: 'Last alerts',
    type: 'heatmap',
    params: {
      type: 'heatmap',
...
const getVisStateRequirementsByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GDPR-Requirements-by-agent',
...
const getVisStateTopRuleGroups = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GDPR-Groups',
...
const getVisStateTopRules = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GDPR-Rule',
    title: 'Top 5 rules',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GDPR-Requirement',
...
const getVisStateAgentTopRequirementsCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GDPR-Requirements',
    title: 'GDPR Requirements',
    type: 'histogram',
    params: {
      type: 'histogram',
...
const getVisStateAgentRuleLevelDistribution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GDPR-Rule-level-distribution',
