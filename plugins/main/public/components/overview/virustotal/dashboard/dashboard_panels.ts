...
const getVisStateTop5UniqueMaliciousFilesPerAgent = (
  ...
  return {
    id: 'Xcyber360-App-Overview-Virustotal-Malicious-Per-Agent',
...
const getVisStateLastScannedFiles = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Virustotal-Last-Files-Pie',
...
const getVisStateAlertsEvolutionByAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Virustotal-Alerts-Evolution',
...
const getVisStateMaliciousFilesAlertsEvolution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Virustotal-Malicious-Evolution',
...
const getVisStateLastFiles = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Virustotal-Files-Table',
    title: 'Last files',
    type: 'table',
    params: {
      perPage: 10,
...
const getVisStateAgentLastScannedFiles = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Virustotal-Last-Files-Pie',
    title: 'Last scanned files',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentMaliciousFilesAlertsEvolution = (
  ...
  return {
    id: 'Xcyber360-App-Agents-Virustotal-Malicious-Evolution',
    title: 'Malicious files alerts Evolution',
    type: 'histogram',
    params: {
      type: 'histogram',
...
const getVisStateAgentLastFiles = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Virustotal-Files-Table',
    title: 'Last files',
    type: 'table',
    params: {
      perPage: 10,
