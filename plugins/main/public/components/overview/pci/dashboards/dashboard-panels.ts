...
const getVisStateTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-PCI-DSS-requirements',
...
const getVisStateTopAgentsByCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-PCI-DSS-Agents',
...
const getVisStateRequirementsHeatmap = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-PCI-DSS-Requirements-Agents-heatmap',
    title: 'Last alerts',
    type: 'heatmap',
    params: {
      type: 'heatmap',
...
const getVisStateRequirementsByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-PCI-DSS-Requirements-by-agent',
...
const getVisStateAgentTopRuleGroups = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-PCI-Groups',
...
const getVisStateAgentTopRules = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-PCI-Rule',
    title: 'Top 5 rules',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-PCI-Requirement',
...
const getVisStateAgentTopRequirementsCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-PCI-Requirements',
...
const getVisStateAgentRuleLevelDistribution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-PCI-Rule-level-distribution',
