...
const getVisStateAlertsEvolution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-MITRE-Alerts-Evolution',
...
const getVisStateTopTactics = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-MITRE-Top-Tactics',
    title: 'Top tactics',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAttacksByTechnique = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-MITRE-Attacks-By-Technique',
...
const getVisStateTopTacticsByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-MITRE-Top-Tactics-By-Agent',
...
const getVisStateTechniqueByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-MITRE-Attacks-By-Agent',
...
const getVisStateAlertsLevelByAttack = indexPatternId => {
  return {
    id: 'Xcyber360-App-Agents-MITRE-Level-By-Attack',
...
const getVisStateMitreAttacksByTactic = indexPatternId => {
  return {
    id: 'Xcyber360-App-Agents-MITRE-Attacks-By-Tactic',
...
const getVisStateAlertsLevelByTactic = indexPatternId => {
  return {
    id: 'Xcyber360-App-Agents-MITRE-Level-By-Tactic',
