...
const getVisStateEventsProcessed = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Events',
...
const getVisStateEventsDropped = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Events-Dropped',
...
const getVisStateQueueUsage = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Queues-Usage',
    title: 'Queue Usage',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateEventsDecodedSummary = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Overview-Events-Decoded',
...
const getVisStateSyscheck = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Syscheck',
    title: 'Syscheck',
    type: 'line',
    params: {
      addLegend: true,
...
const getVisStateSyscollector = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Syscollector',
    title: 'Syscollector',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateRootcheck = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Rootcheck',
    title: 'Rootcheck',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateSCA = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-SCA',
    title: 'SCA',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateHostInfo = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-HostInfo',
    title: 'Host Info',
    type: 'line',
    params: {
      addLegend: true,
...
const getVisStateEventsProcessedByNode = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Events-By-Node',
    title: 'Events processed',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateEventsDroppedByNode = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Statistics-Analysisd-Events-Dropped-By-Node',
    title: 'Events dropped',
    type: 'line',
    params: {
      type: 'line',
