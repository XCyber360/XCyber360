...
const getVisStateAlertsEvolutionByOrganization = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Alerts-Evolution-By-Organization',
...
const getVisStateTopOrganizationsByAlertCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Top-5-Organizations-By-Alerts',
...
const getVisStateActionTypeByOrganization = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Alert-Action-Type-By-Organization',
...
const getVisStateUsersWithMoreAlerts = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Users-With-More-Alerts',
...
const getVisStateAgentAlertsEvolutionByOrganization = (
  ...
  return {
    id: 'Xcyber360-App-Agents-GitHub-Alerts-Evolution-By-Organization',
    title: 'Alerts evolution by organization',
    type: 'area',
    params: {
      type: 'area',
...
const getVisStateAgentTopOrganizationsByAlertCount = (
  ...
  return {
    id: 'Xcyber360-App-Agents-GitHub-Top-5-Organizations-By-Alerts',
    title: 'Top 5 organizations by alerts',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentActionTypeByOrganization = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GitHub-Alert-Action-Type-By-Organization',
    title: 'Top alerts by action type and organization',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentUsersWithMoreAlerts = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GitHub-Users-With-More-Alerts',
    title: 'Users with more alerts',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateMetricOrganizationsCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-GitHub-Metric-Organizations-Count',
    title: '',
    type: 'metric',
    params: {
      addTooltip: true,
...
const getVisStateMetricRepositoriesCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-GitHub-Metric-Repositories-Count',
    title: '',
    type: 'metric',
    params: {
      addTooltip: true,
...
const getVisStateMetricActorsCount = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-GitHub-Metric-Actors-Count',
    title: '',
    type: 'metric',
    params: {
      addTooltip: true,
