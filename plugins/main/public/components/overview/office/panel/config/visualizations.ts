export const getVisStateOfficeMetricStats = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Metric-Stats',
    title: 'Stats',
    type: 'metric',
    params: {
      addTooltip: true,
...
export const getVisStateOfficeTopsEventsPie = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Top-Events-Pie',
    title: 'Top Events',
    type: 'pie',
    params: {
      type: 'pie',
...
export const getVisStateOfficeUserOperationLevel = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-User-Operation-Level-Table',
...
export const getVisStateOfficeAlertsEvolutionByUser = (
  ...
  return {
    id: 'Xcyber360-App-Overview-Office-Alerts-Evolution-By-User',
...
export const getVisStateTopOfficeUsers = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Top-Users',
...
export const getVisStateOfficeCountryTagCloud = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Country-Tag-Cloud',
...
export const getVisStateOfficeAlertsEvolutionByUserID = (
  ...
  return {
    id: 'Xcyber360-App-Overview-Office-Alerts-Evolution-By-UserID',
...
export const getVisStateOfficeTopOperations = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Top-Operations',
...
export const getVisStateOfficeClientIPOperationLevelTable = (
  ...
  return {
    id: 'Xcyber360-App-Overview-Office-Client-IP-Operation-Level-Table',
