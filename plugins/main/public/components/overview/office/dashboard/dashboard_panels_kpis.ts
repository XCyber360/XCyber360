...
const getVisStateMaxRuleLevel = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Metric-Max-Rule-Level',
...
const getVisStateSuspiciousDownloads = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Metric-Suspicious-Downloads',
...
const getVisStateFullAccess = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Metric-FullAccess-Permissions',
...
const getVisStatePhishingMalware = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Phishing-Malware',
