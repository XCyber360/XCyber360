...
const getVisStateTop5Images = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Docker-top-5-images',
    title: 'Top 5 images',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateTop5Events = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Docker-top-5-events',
    title: 'Top 5 events',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateEventsSourceByOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Docker-Events-By-Source-Over-Time',
...
const getVisStateEvents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Docker-Events',
    title: 'Events',
    type: 'table',
    params: {
      perPage: 10,
...
const getVisStateAgentTop5Images = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Docker-top-5-images',
    title: 'Top 5 images',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentTop5Events = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Docker-top-5-actions',
    title: 'Top 5 events',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentResourcesUsageByOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Docker-Types-over-time',
...
const getVisStateAgentEvents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-Docker-Actions-over-time',
