/*
 * Xcyber360 app - Simple description for each App tabs
...
import {
  Xcyber360Discover,
  Xcyber360DiscoverProps,
} from '../xcyber360-discover/wz-discover';
import { threatHuntingColumns } from '../xcyber360-discover/config/data-grid-columns';
...
import { XCYBER360_VULNERABILITIES_PATTERN } from '../../../../common/constants';
import {
  DashboardGitHub,
  DashboardGDPR,
  DashboardPCIDSS,
...
const renderDiscoverTab = (props: Xcyber360DiscoverProps) => {
  return {
    id: 'events',
    name: 'Events',
    buttons: [ButtonExploreAgent],
    component: () => <Xcyber360Discover {...props} />,
  };
};
export const ModulesDefaults = {
  ...
  // This module is Malware Detection. Ref: https://github.com/XCyber360/XCyber360/tree/master/dashboard/plugins/issues/5893
  pm: {
    init: 'dashboard',
    tabs: [
      {
    ...
    tabs: [
      {
        ...
        /* For ButtonExploreAgent to insert correctly according to the module's index pattern, the moduleIndexPatternTitle parameter is added. By default it applies the index pattern xcyber360-alerts-* */
        buttons: [],
      },
      {
        id: 'dashboard',
        ...
        /* For ButtonExploreAgent to insert correctly according to the module's index pattern, the moduleIndexPatternTitle parameter is added. By default it applies the index patternt xcyber360-alerts-* */
        buttons: [
          ({ ...props }) => (
            <ButtonExploreAgent
              {...props}
              moduleIndexPatternTitle={XCYBER360_VULNERABILITIES_PATTERN}
            />
          ),
        ],
      },
