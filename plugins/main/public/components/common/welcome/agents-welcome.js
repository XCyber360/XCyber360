      ...
      return (
        <Fragment>
          {this.state.menuAgent.map((applicationId, i) => {
            const moduleID = Object.keys(XCYBER360_MODULES).find(
              key => XCYBER360_MODULES[key]?.appId === applicationId,
            ).appId;
            if (
                ...
                <EuiPageBody component='div'>
                  ...
                  {(this.state.widthWindow < 1150 && (
                    <Fragment>
                      <EuiFlexGroup wrap>
                        <EuiFlexItem
                          key={'Xcyber360-App-Agents-Welcome-MITRE-Top-Tactics'}
                        >
                      ...
                      <EuiFlexGroup>
                        <EuiFlexItem
                          key={'Xcyber360-App-Agents-Welcome-Events-Evolution'}
                        >
                          {' '}
