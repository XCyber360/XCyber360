...
export type Xcyber360DiscoverProps = {
...
const Xcyber360FlyoutDiscoverComponent = (props: Xcyber360DiscoverProps) => {
  const {
    DataSource,
      ...
      <EuiFlexGroup className='flyout-row'>
        <EuiFlexItem>
          {isDataSourceLoading ? (
            ...
            <WzSearchBar
              appName='xcyber360-discover-search-bar'
              {...searchBarProps}
...
export const Xcyber360FlyoutDiscover = withErrorBoundary(
  Xcyber360FlyoutDiscoverComponent,
);
