/*
 * Xcyber360 app - Check alerts index pattern service
 *
...
import {
  ...
  XCYBER360_PLUGIN_PLATFORM_SETTING_MAX_BUCKETS,
  XCYBER360_PLUGIN_PLATFORM_SETTING_METAFIELDS,
  XCYBER360_PLUGIN_PLATFORM_SETTING_TIME_FILTER,
...
const checkTimeFilter = decoratorHealthCheckRunCheckEnabled('timeFilter',
  checkPluginPlatformSettings(
    PLUGIN_PLATFORM_SETTING_NAME_TIME_FILTER,
    JSON.stringify(XCYBER360_PLUGIN_PLATFORM_SETTING_TIME_FILTER),
    (checkLogger: CheckLogger, options: { defaultAppValue: any }) => {
      getDataPlugin().query.timefilter.timefilter.setTime(XCYBER360_PLUGIN_PLATFORM_SETTING_TIME_FILTER)
