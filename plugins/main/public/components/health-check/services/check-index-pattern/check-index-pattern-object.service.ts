...
export const checkIndexPatternObjectService = async (
  ...
  let listValidIndexPatterns =
    await SavedObject.getListOfXcyber360ValidIndexPatterns(
  ...
  if (!indexPatternDefaultFound && defaultPatternId) {
    // if no valid index patterns are found we try to create the xcyber360-alerts-*
    try {
      checkLogger.info(
      ...
      if (existDefaultIndexPattern) {
        ...
        await SavedObject.createXcyber360IndexPattern(defaultPatternId);
      ...
      if (!AppState.getCurrentPattern()) {
        ...
        // Related issue: https://github.com/XCyber360/XCyber360/tree/master/dashboard/plugins/issues/4293
