/*
 * Xcyber360 app - Module to transform seconds interval to cron readable format
...
import { XCYBER360_MONITORING_DEFAULT_CRON_FREQ } from '../../common/constants';
...
export function parseCron(interval: string) {
  try {
    ...
    return XCYBER360_MONITORING_DEFAULT_CRON_FREQ;
  }
}
