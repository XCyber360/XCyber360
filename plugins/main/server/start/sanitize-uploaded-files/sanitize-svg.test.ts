...
describe('[Sanitize SVG cronjob] Sanitize different custom logos.', () => {
  ...
  describe('[Sanitize SVG cronjob] No custom logos setup.', () => {
    it('With no custom logos does not sanitize any file', async () => {
      mockContext.xcyber360_core.configuration.get.mockImplementationOnce(
        () => ({}),
      );
      mockContext.xcyber360_core.configuration._settings.get.mockImplementation(
        key =>
          Object.fromEntries(
            [
  ...
  describe('[Sanitize SVG cronjob] No custom logos setup.', () => {
    ...
    it('[Sanitize SVG cronjob] Sanitize script in customization.logo.app.svg file', async () => {
      ...
      mockContext.xcyber360_core.configuration._settings.get.mockImplementationOnce(
        () =>
          Object.fromEntries(
            [
              'customization.logo.sidebar',
