/*
 * Xcyber360 app - Module for Xcyber360 utils routes
 ...
 */
import { Xcyber360UtilsCtrl } from '../../controllers';
...
export function Xcyber360UtilsRoutes(router: IRouter, services) {
  const ctrl = new Xcyber360UtilsCtrl();
