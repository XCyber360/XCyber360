// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/xcyber360-elastic
...
describe.skip('Xcyber360 Elastic', () => {
  describe('Xcyber360 API - /elastic/security/current-platform', () => {
  ...
  // describe('Xcyber360 API - /elastic/visualizations/{tab}/{pattern}', () => {
  ...
  describe('Xcyber360 API - /elastic/template/{pattern}', () => {
    test('[200] Check if there is some template with the pattern', () => {
      const options = buildAxiosOptions('get', '/elastic/template/xcyber360-alerts-*');
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
  ...
  // TODO: This test need to be defined
  // describe('Xcyber360 API - /elastic/top/{mode}/{cluster}/{field}/{pattern}', () => {
  ...
  describe('Xcyber360 API - /elastic/samplealerts', () => {
  ...
  describe('Xcyber360 API - /elastic/samplealerts/{category}', () => {
  ...
  // TODO: This test need to be defined
  // describe('Xcyber360 API - /elastic/alerts', () => {
  //   test('[200] Check if there an sample data index of Security category', () => {
  ...
  describe('Xcyber360 API - /elastic/statistics', () => {
    test('[200] Check if there an sample data index of Security category', () => {
