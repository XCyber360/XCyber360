/*
 * Xcyber360 app - Overview -> general test
...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  const PageObjects = getPageObjects(['xcyber360Common', 'common']);
  ...
  describe.skip('integrity_monitoring', () => {
    let es_index: string;
    before(async () => {
      await PageObjects.xcyber360Common.OpenIntegrityMonitoring();
      es_index = 'xcyber360-alerts-*'; // TODO: use the configuration service
    });

    beforeEach(async () => {
      await PageObjects.xcyber360Common.setTodayRange();
    });
    ...
    it('should Alerts by action over time values are correct', async () => {
      const chartSelector: string =
        '#Xcyber360-App-Agents-FIM-Alerts-by-action-over-time';
    ...
    it('should Top 5 agents values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-Top-5-agents-pie';
    ...
    it('should Events summary values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-Events-summary';
      const values: object = await areaChart.getValues(chartSelector);
    ...
    it('should Rule distribution values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-Top-5-rules';
      const values = await pieCharts.getValues(chartSelector);
    ...
    it('should Actions values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-Common-actions';
      const values = await pieCharts.getValues(chartSelector);
    ...
    it('should Top 5 users values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-top-agents-user';
    ...
    it('should Alerts summary values are correct', async () => {
      const chartSelector: string = '#Xcyber360-App-Overview-FIM-Alerts-summary';
      const values: object[] = await tableViz.getValues(chartSelector);
