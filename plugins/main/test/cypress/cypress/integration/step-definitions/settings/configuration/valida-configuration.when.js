...
Then('The app current settings are displayed', () => {
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(settingSubTitle, 'Configuration file located at /usr/share/xcyber360-dashboard/data/xcyber360/config/xcyber360.yml') : elementTextIncludes(settingSubTitle, texts.configurationDescription);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(generalPanelEnrollmentDescription, 'Specifies the Xcyber360 registration server, used for the agent enrollment.') : elementTextIncludes(generalPanelEnrollmentDescription, texts.Panel[0].items[8].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(healthCheckPanelRemoveMetaFieldsPrefixDescription, 'Change the default value of the Xcyber360 dashboard metaField configuration') : elementTextIncludes(healthCheckPanelRemoveMetaFieldsPrefixDescription, texts.Panel[1].items[5].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(healthCheckPanelSetBucketPrefixDescription, 'Change the default value of the Xcyber360 dashboard max buckets configuration') : elementTextIncludes(healthCheckPanelSetBucketPrefixDescription, texts.Panel[1].items[6].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(healthCheckPanelSetTimePrefixDescription, 'Change the default value of the Xcyber360 dashboard timeFilter configuration') : elementTextIncludes(healthCheckPanelSetTimePrefixDescription, texts.Panel[1].items[7].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(monitoringPanelFrequencyDescription, 'Frequency, in seconds, of API requests to get the state of the agents and create a new document in the xcyber360-monitoring index with this data.') : elementTextIncludes(monitoringPanelFrequencyDescription, texts.Panel[2].items[1].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(monitoringPanelIndexCreationDescription, 'Define the interval in which a new xcyber360-monitoring index will be created.') : elementTextIncludes(monitoringPanelIndexCreationDescription, texts.Panel[2].items[4].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(monitoringPanelIndexPatternDescription, 'Default index pattern to use for Xcyber360 monitoring.') : elementTextIncludes(monitoringPanelIndexPatternDescription, texts.Panel[2].items[5].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(LogosCustomizationPanelLogoAppDescription, 'Set the name of the app logo stored at /plugins/xcyber360/public/assets/') : elementTextIncludes(LogosCustomizationPanelLogoAppDescription, texts.Panel[4].items[0].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(LogosCustomizationPanelLogosSidebarDescription, 'Set the name of the sidebar logo stored at /plugins/xcyber360/public/assets') : elementTextIncludes(LogosCustomizationPanelLogosSidebarDescription, texts.Panel[4].items[1].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(LogosCustomizationPanelLogoHealthCheckDescription, 'Set the name of the health-check logo stored at /plugins/xcyber360/public/assets/') : elementTextIncludes(LogosCustomizationPanelLogoHealthCheckDescription, texts.Panel[4].items[2].subTitle);
    ...
    (Cypress.env('type') == 'wzd') ? elementTextIncludes(LogosCustomizationPanelLogoReportDescription, 'Set the name of the reports logo (.png) stored at /plugins/xcyber360/public/assets/') : elementTextIncludes(LogosCustomizationPanelLogoReportDescription, texts.Panel[4].items[3].subTitle);
