export const XCYBER360_MENU_PAGE = {
  xcyber360MenuLeft: '.wz-menu-left-side .wz-menu-sections',
  xcyber360MenuRight: '.wz-menu-right-side',
  xcyber360MenuSettingRight: '.wz-menu-right-side .WzManagementSideMenu',
  xcyber360MenuButton: '[data-test-subj=menuXcyber360Button]',
  //region Menu
  //region Menu
