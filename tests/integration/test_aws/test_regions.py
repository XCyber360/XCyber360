...
from xcyber360_testing.constants.aws import RANDOM_ACCOUNT_ID
from xcyber360_testing.constants.paths.aws import AWS_SERVICES_DB_PATH, S3_CLOUDTRAIL_DB_PATH
from xcyber360_testing.modules.aws.utils import path_exist
from xcyber360_testing.utils.db_queries.aws_db import (get_multiple_service_db_row, table_exists_or_has_values,
...
def test_regions(
        test_configuration, metadata, load_xcyber360_basic_configuration,  create_test_bucket, manage_bucket_files,
        set_xcyber360_configuration, clean_s3_cloudtrail_db, configure_local_internal_options_function,
        truncate_monitored_files, restart_xcyber360_function, file_monitoring
):
    """
    ...
    parameters:
        ...
        - truncate_monitored_files:
            type: fixture
            brief: Truncate xcyber360 logs.
        - restart_xcyber360_daemon_function:
            type: fixture
            brief: Restart the xcyber360 service.
        - file_monitoring:
            type: fixture
...
def test_cloudwatch_regions(
        test_configuration, metadata, load_xcyber360_basic_configuration, create_test_log_group, create_test_log_stream,
        manage_log_group_events, set_xcyber360_configuration, clean_aws_services_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_xcyber360_function, file_monitoring
):
    """
    description: Only the logs for the specified region are processed.
    test_phases:
...
def test_inspector_regions(
        test_configuration, metadata, load_xcyber360_basic_configuration,
        set_xcyber360_configuration, clean_aws_services_db, configure_local_internal_options_function,
        truncate_monitored_files, restart_xcyber360_function, file_monitoring
):
    """
    description: Only the logs for the specified region are processed.
