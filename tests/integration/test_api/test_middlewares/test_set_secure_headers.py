...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'xcyber360-apid' daemon is
       working properly. The Xcyber360 API is an open source 'RESTful' API that allows for interaction with the Xcyber360
...
from xcyber360_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES
