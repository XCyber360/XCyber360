# Copyright (C) 2015-2021, Xcyber360 Inc.
...
from . import XCYBER360_PYTHON_INTERPRETER_PATH, MOCK_SERVER_PATH, MOCK_SERVER_IMAGE, MOCK_SERVER_CONTAINER
...
def disable_ssl_verification():
    """Modify xcyber360/core/utils.py to avoid SSL certificate verification."""
    file_path = Path(XCYBER360_PYTHON_INTERPRETER_PATH, '/xcyber360/core/utils.py')
