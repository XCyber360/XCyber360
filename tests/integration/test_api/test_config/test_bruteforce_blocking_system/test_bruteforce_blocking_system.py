...
brief: These tests will check if the IP blocking feature of the API handled by the 'xcyber360-apid' daemon
       is working properly. The Xcyber360 API is an open source 'RESTful' API that allows for interaction
...
from xcyber360_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
