...
def test_upload_configuration(test_configuration, test_metadata, backup_xcyber360_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_xcyber360_configuration:
            type: fixture
            brief: Save the initial xcyber360 configuration and restore it after the test.
        - add_configuration:
            type: fixture
