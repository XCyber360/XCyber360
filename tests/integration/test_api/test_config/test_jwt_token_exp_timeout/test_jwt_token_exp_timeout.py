...
brief: These tests will check if the 'auth_token_exp_timeout' setting of the API is working properly.
       ...
       The Xcyber360 API is an open source 'RESTful' API that allows for interaction with the Xcyber360 manager
...
references:
    ...
    - https://documentation.xcyber360.com/current/user-manual/api/configuration.html#auth-token-exp-timeout
