...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'xcyber360-apid' daemon is working properly. The Xcyber360 API is an open source 'RESTful' API
...
references:
    ...
    - https://documentation.xcyber360.com/current/user-manual/api/configuration.html#access
...
from xcyber360_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE
from xcyber360_testing.constants.daemons import API_DAEMONS_REQUIREMENTS
from xcyber360_testing.modules.api.utils import get_base_url, login
