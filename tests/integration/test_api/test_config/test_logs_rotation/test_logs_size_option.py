...
from xcyber360_testing.constants.api import CONFIGURATION_TYPES, XCYBER360_API_PORT
from xcyber360_testing.utils.configuration import get_test_cases_data, load_configuration_template
from xcyber360_testing.constants.paths.logs import XCYBER360_API_LOG_FILE_PATH
from xcyber360_testing.tools.monitors import file_monitor
from xcyber360_testing.utils import services
...
def test_logs_rotation_size_option_values(test_configuration, test_metadata, add_configuration,
    ...
    try:
        # Restart the API
        services.control_service('restart', 'xcyber360-apid')
    ...
    if expected_error_code == 0:
        ...
        # Monitor de API logs
        monitor_start_message = file_monitor.FileMonitor(XCYBER360_API_LOG_FILE_PATH)
