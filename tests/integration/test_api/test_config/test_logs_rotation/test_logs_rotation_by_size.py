...
from xcyber360_testing.utils import file
from xcyber360_testing.constants.paths.logs import BASE_LOGS_PATH
...
def test_logs_rotate_to_expected_path(test_configuration, test_metadata, add_configuration, truncate_monitored_files,
    ...
    file.write_file(XCYBER360_API_LOG_FILE_PATH, [" " for _ in range(total_size_in_kb)])
