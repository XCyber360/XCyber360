...
async def restore_default_passwords(script_args):
    ...
    from xcyber360.core.common import DEFAULT_RBAC_RESOURCES
    from xcyber360.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from xcyber360.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Xcyber360 RBAC tool: manage resources from the Xcyber360 RBAC database")
