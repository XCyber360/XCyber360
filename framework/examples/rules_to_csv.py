...
# Instructions:
#  - Use the embedded interpreter to run the script: {xcyber360_path}/framework/python/bin/python3 rules_to_csv.py

import csv
import sys

import xcyber360.rule
...
if __name__ == '__main__':
    ...
    for step in range(0, n_rules, 500):
        result = xcyber360.rule.get_rules(limit=500, offset=step).render()
        if not result:
            break
