...
from xcyber360.core.indexer.agent import AgentsIndex, AGENT_KEY
from xcyber360.core.indexer.base import IndexerKey
from xcyber360.core.indexer.models.agent import Agent
...
class TestAgentIndex:
    ...
    async def test_create_ko(self, index_instance: AgentsIndex, client_mock: mock.AsyncMock):
        ...
        with pytest.raises(Xcyber360Error, match='.*1708.*'):
    ...
    async def test_search(self, index_instance: AgentsIndex, client_mock: mock.AsyncMock):
        ...
        with mock.patch('xcyber360.core.indexer.agent.get_source_items', return_value=search_result):
    ...
    async def test_add_agents_to_group(self, index_instance: AgentsIndex, override):
        ...
        with mock.patch('xcyber360.core.indexer.agent.AgentsIndex._update_groups') as mock_update:
