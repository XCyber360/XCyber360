...
from xcyber360.core.indexer.commands import CommandsManager, STATUS_KEY, TARGET_ID_KEY, create_restart_command, \
    COMMAND_USER_NAME, create_set_group_command, create_update_group_command
from xcyber360.core.indexer.base import IndexerKey, POST_METHOD
from xcyber360.core.indexer.utils import convert_enums
from xcyber360.core.indexer.models.commands import Action, Command, Source, Status, Target, TargetType, \
...
class TestCommandsManager:
    ...
    async def test_create_ko(self, index_instance: CommandsManager, client_mock: mock.AsyncMock):
        ...
        with pytest.raises(Xcyber360Error, match='.*1761.*'):
