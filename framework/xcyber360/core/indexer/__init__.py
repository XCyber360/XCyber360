...
from xcyber360.core.indexer.agent import AgentsIndex
from xcyber360.core.indexer.commands import CommandsManager
from xcyber360.core.indexer.events import EventsIndex
...
class Indexer:
    """Interface to connect with Xcyber360 Indexer."""
    ...
    async def connect(self) -> None:
        """Connect to the Xcyber360 Indexer.

        Raises
        ------
        Xcyber360IndexerError
            In case of errors communicating with the Xcyber360 Indexer.
        """
        if not (await self._client.ping()):
            raise Xcyber360IndexerError(2200)

    async def close(self) -> None:
        """Close the Xcyber360 Indexer client."""
...
async def create_indexer(
    ...
    **kwargs,
    ...
    ----------
    host : str
        Location of the Xcyber360 Indexer.
    user : str, optional
        User of the Xcyber360 Indexer to authenticate with.
    password : str, optional
        Password of the Xcyber360 Indexer to authenticate with.
    port : int, optional
        Port of the Xcyber360 Indexer to connect with, by default 9200
