...
from xcyber360.core.indexer.bulk import Operation
from xcyber360.core.indexer.commands import CommandsManager
from xcyber360.core.indexer.models.agent import Host as AgentHost
from xcyber360.core.indexer.models.commands import Result

FIM_INDEX = 'xcyber360-states-fim'
INVENTORY_NETWORK_INDEX = 'xcyber360-states-inventory-network'
INVENTORY_PACKAGES_INDEX = 'xcyber360-states-inventory-packages'
INVENTORY_PROCESSES_INDEX = 'xcyber360-states-inventory-processes'
INVENTORY_SYSTEM_INDEX = 'xcyber360-states-inventory-system'
SCA_INDEX = 'xcyber360-states-sca'
VULNERABILITY_INDEX = 'xcyber360-states-vulnerabilities'
...
def get_module_index_name(module: Module, type: Optional[str] = None) -> str:
    ...
    if module == Module.INVENTORY:
        ...
        raise Xcyber360Error(1763)

    try:
        return STATEFUL_EVENTS_INDICES[module]
    except KeyError:
        raise Xcyber360Error(1765)
