...
from xcyber360.core.utils import Xcyber360DBQuery, Xcyber360DBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from xcyber360.core.wdb import Xcyber360DBConnection


class Xcyber360DBQuerySyscheck(Xcyber360DBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=Xcyber360DBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: Xcyber360DBConnection) -> None:
