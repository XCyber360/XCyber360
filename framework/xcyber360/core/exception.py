...
from xcyber360.core.cluster import __version__
from xcyber360.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE, XCYBER360_SERVER_YML

GENERIC_ERROR_MSG = "Xcyber360 Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class Xcyber360Exception(Exception):
    """
    Xcyber360 Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Xcyber360 API',
        ...
        1000: {'message': 'Xcyber360 Internal Error',
               'remediation': 'Please, check `/var/log/xcyber360-server/cluster.log` and '
                              '`/var/log/xcyber360-server/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Xcyber360 directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `xcyber360` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Xcyber360 to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Xcyber360 directories'},
        1017: 'Some Xcyber360 daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Xcyber360 log file',
               'remediation': 'Please check `XCYBER360_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `XCYBER360_PATH/bin/xcyber360-logtest -t` to check your configuration'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.xcyber360.com/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.xcyber360.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'xcyber360' user",
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `XCYBER360_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/api/'
        ...
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `XCYBER360_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.xcyber360.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1209: {'message': 'Invalid relative directory. A \'rule_dir\' tag must '
               ...
               'remediation': f'Please, visit the official documentation '
                              f'(https://documentation.xcyber360.com/'
        ...
        1211: {'message': 'Invalid relative directory. A \'rule_dir\' tag is declared in ossec.conf '
               ...
               'remediation': f'Please, visit the official documentation'
                               '(https://documentation.xcyber360.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/ruleset.html)'
                              ' to get more information about the rules'
               },
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/xcyber360/xcyber360/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'Xcyber360 authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.xcyber360.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.xcyber360.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running Xcyber360 syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `XCYBER360_HOME/etc/ossec.conf`"},
        ...
        2703: {'message': 'Xcyber360 comms API SSL error. Please, ensure the configuration is correct'},
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at XCYBER360_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `xcyber360-manager` service.'},
        3024: "Length of command exceeds limit defined in xcyber360.cluster.common.Handler.cmd_len.",
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.xcyber360.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `xcyber360-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.xcyber360.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `xcyber360-manager` service in the node"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.xcyber360.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"xcyber360.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct Xcyber360\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.xcyber360.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (xcyber360) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in the {XCYBER360_SERVER_YML} file'},
        6002: {'message': 'The body type is not the one specified in the content-type'},
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: XCYBER360_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.xcyber360.com/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a Xcyber360Exception object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Xcyber360 Internal error',
            'logfile': XCYBER360_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, Xcyber360Exception):
    ...
    def __or__(self, other):
        if isinstance(other, Xcyber360Exception):
...
class Xcyber360InternalError(Xcyber360Exception):
    """
    ...
    _default_title = "Xcyber360 Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a Xcyber360InternalError exception.
...
class Xcyber360ClusterError(Xcyber360InternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Xcyber360 Cluster Error"


class Xcyber360HAPHelperError(Xcyber360ClusterError):
    """
...
class Xcyber360CommsAPIError(Xcyber360InternalError):
    """
...
class Xcyber360EngineError(Xcyber360InternalError):
    """
    This type of exception is raised inside the engine.
    """
    _default_type = "about:blank"
    _default_title = "Xcyber360 Engine Error"


class Xcyber360IndexerError(Xcyber360InternalError):
    """
    This type of exception is raised inside the indexer.
    """
    _default_type = "about:blank"
    _default_title = "Xcyber360 Indexer Error"


class Xcyber360Error(Xcyber360Exception):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a Xcyber360Error exception.
    ...
    def __or__(self, other):
        result: Xcyber360Error = super().__or__(other)
        if isinstance(result, Xcyber360Error):
...
class Xcyber360PermissionError(Xcyber360Error):
    """
...
class Xcyber360ResourceNotFound(Xcyber360Error):
    """
...
class Xcyber360TooManyRequests(Xcyber360Error):
    """
...
class Xcyber360NotAcceptable(Xcyber360Error):
    """
