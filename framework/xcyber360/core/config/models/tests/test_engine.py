...
from xcyber360.core.config.models.engine import EngineClientConfig, EngineConfig, DEFAULT_ENGINE_SOCKET_PATH

valid_socket_path = "/var/xcyber360/queue/example.sock"
valid_retries = 5
valid_timeout = 20.0
