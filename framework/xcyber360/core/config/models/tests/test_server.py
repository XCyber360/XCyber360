...
from xcyber360.core.config.models.server import MasterIntervalsConfig, MasterProcesses, MasterConfig, NodeConfig, \
...
@pytest.mark.parametrize("init_values, expected", [
    ...
    ({"update_check": False, "url": "www.xcyber360.com"}, {"update_check": False, "url": "www.xcyber360.com"})
])
