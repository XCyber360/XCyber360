...
from xcyber360.core.config.models.ssl_config import SSLConfig
...
class MasterIntervalsConfig(Xcyber360ConfigBaseModel):
...
class MasterProcesses(Xcyber360ConfigBaseModel):
...
class MasterConfig(Xcyber360ConfigBaseModel):
...
class NodeConfig(Xcyber360ConfigBaseModel):
...
class ZipConfig(Xcyber360ConfigBaseModel):
...
class CommunicationsTimeoutConfig(Xcyber360ConfigBaseModel):
...
class CommunicationsConfig(Xcyber360ConfigBaseModel):
...
class WorkerIntervalsConfig(Xcyber360ConfigBaseModel):
...
class WorkerRetriesConfig(Xcyber360ConfigBaseModel):
...
class WorkerConfig(Xcyber360ConfigBaseModel):
...
class SharedFiles(Xcyber360ConfigBaseModel):
...
class ServerSyncConfig(Xcyber360ConfigBaseModel):
...
class CTIConfig(Xcyber360ConfigBaseModel):
    ...
    url : str
        The URL for the CTI service. Default is "https://cti.xcyber360.com".
    """
...
class ServerConfig(Xcyber360ConfigBaseModel):
