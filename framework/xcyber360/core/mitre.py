...
from xcyber360.core.utils import Xcyber360DBQuery, Xcyber360DBBackend, get_utc_strptime
from xcyber360.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each Xcyber360DBQuery
# TACTICS_REQUEST_SLICE = 500  # Default Xcyber360DBQueryMitre request_slice value
...
class Xcyber360DBQueryMitre(Xcyber360DBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the Xcyber360DBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the Xcyber360DBBacked backend object.
        distinct : bool
        ...
        Xcyber360DBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=Xcyber360DBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class Xcyber360DBQueryMitreMetadata(Xcyber360DBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the Xcyber360DBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        Xcyber360DBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class Xcyber360DBQueryMitreRelational(Xcyber360DBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of Xcyber360DBQueryMitre.
...
class Xcyber360DBQueryMitreRelationalPhase(Xcyber360DBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the Xcyber360DBQueryMitreRelationalPhase class.
...
class Xcyber360DBQueryMitreRelationalMitigate(Xcyber360DBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the Xcyber360DBQueryMitreRelationalMitigate class.
...
class Xcyber360DBQueryMitreRelationalUse(Xcyber360DBQueryMitreRelational):
...
class Xcyber360DBQueryMitreMitigations(Xcyber360DBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the Xcyber360DBQueryMitreMitigations class.
        ...
        Xcyber360DBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with Xcyber360DBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with Xcyber360DBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class Xcyber360DBQueryMitreReferences(Xcyber360DBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the Xcyber360DBQueryMitreReferences class.
...
class Xcyber360DBQueryMitreTactics(Xcyber360DBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Xcyber360DBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with Xcyber360DBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with Xcyber360DBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Xcyber360DBQueryMitreTechniques(Xcyber360DBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Xcyber360DBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with Xcyber360DBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with Xcyber360DBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with Xcyber360DBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with Xcyber360DBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with Xcyber360DBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Xcyber360DBQueryMitreGroups(Xcyber360DBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Xcyber360DBQueryMitreGroups class.
        ...
        Xcyber360DBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with Xcyber360DBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with Xcyber360DBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Xcyber360DBQueryMitreSoftware(Xcyber360DBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with Xcyber360DBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        Xcyber360DBQueryMitre class used to obtain certain MITRE resources.
