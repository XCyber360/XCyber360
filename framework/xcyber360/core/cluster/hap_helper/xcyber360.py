...
class Xcyber360Agent:
    """Tools to handle Xcyber360 agents connections."""
...
class Xcyber360DAPI:
    """Class to call Xcyber360 DAPI functions."""
    ...
    def _get_logger(tag: str) -> logging.Logger:
        ...
        """
        logger = logging.getLogger('xcyber360').getChild('Xcyber360DAPI')
