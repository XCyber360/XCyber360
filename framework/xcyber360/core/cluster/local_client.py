...
from xcyber360.core.cluster import client
    ...
    async def start(self):
        ...
        try:
            self.transport, self.protocol = await loop.create_unix_connection(
                                                ...
                                                path=common.XCYBER360_SOCKET / common.LOCAL_SERVER_SOCKET
                                            )
        except (ConnectionRefusedError, FileNotFoundError):
            raise exception.Xcyber360InternalError(3012)
        except MemoryError:
            raise exception.Xcyber360InternalError(1119)
        except Exception as e:
            raise exception.Xcyber360InternalError(3009, str(e))
        ...
        while True:
            ...
            try:
                ...
                if min_timeout < self.server_config.worker.intervals.keep_alive:
                    raise exception.Xcyber360InternalError(3020)
                else:
                    try:
