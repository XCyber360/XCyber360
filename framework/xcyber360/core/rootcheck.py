...
class Xcyber360DBQueryRootcheck(Xcyber360DBQuery):
    """Rootcheck Xcyber360DBQuery object."""
    fields = {
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, sort: dict, search: dict, select: list, query: str,
        ...
        backend = Xcyber360DBBackend(agent_id)
        Xcyber360DBQuery.__init__(self, offset=offset, limit=limit, table='pm_event', sort=sort, search=search,
    ...
    def _filter_status(self, filter_status: dict):
        ...
        if filter_status['value'] == 'all':
            ...
            raise Xcyber360Exception(1603, filter_status['value'])
...
def rootcheck_delete_agent(agent: str, wdb_conn: Xcyber360DBConnection) -> None:
