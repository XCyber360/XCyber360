...
from xcyber360.core.utils import Xcyber360DBQuery, Xcyber360DBBackend, get_date_from_timestamp
...
class Xcyber360DBQuerySCA(Xcyber360DBQuery):
    ...
    def __init__(self, agent_id: str, offset: int, limit: Union[int, None], sort: Union[dict, None],
        ...
        self.default_query = default_query if default_query else \
            Xcyber360DBQuerySCA.DEFAULT_QUERY if not distinct else Xcyber360DBQuerySCA.DEFAULT_QUERY_DISTINCT
        Agent(agent_id).get_basic_information()  # check if the agent exists

        Xcyber360DBQuery.__init__(self, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                              ...
                              min_select_fields=min_select_fields, backend=Xcyber360DBBackend(agent_id))
...
class Xcyber360DBQuerySCACheck(Xcyber360DBQuerySCA):
    ...
    def __init__(self, agent_id: str, select: list, sort: dict, sca_checks_ids: list):
        ...
        Xcyber360DBQuerySCA.__init__(self, agent_id=agent_id, offset=0, limit=None, sort=sort, filters={}, search=None,
    ...
    def _parse_select_filter(self, select_fields):
        if select_fields:
            ...
            if not set_select_fields or not set_select_fields.issubset(set_fields_keys):
                ...
                raise Xcyber360Error(1724, "Allowed select fields: {0}. Fields {1}".format(
...
class Xcyber360DBQuerySCACheckIDs(Xcyber360DBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        Xcyber360DBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters=filters,
...
class Xcyber360DBQuerySCACheckRelational(Xcyber360DBQuerySCA):
    ...
    def __init__(self, agent_id: str, table: str, id_check_list: list, select: list):
        ...
        Xcyber360DBQuerySCA.__init__(self, agent_id=agent_id, default_query=default_query,
...
class Xcyber360DBQueryDistinctSCACheck(Xcyber360DBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        with Xcyber360DBQuerySCA(agent_id=agent_id, offset=0, limit=None, sort=sort,
        ...
        Xcyber360DBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters={}, search={},
