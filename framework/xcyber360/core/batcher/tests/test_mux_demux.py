...
from framework.xcyber360.core.batcher.mux_demux import MuxDemuxQueue, Item, MuxDemuxManager
...
@patch('framework.xcyber360.core.batcher.mux_demux.SyncManager')
@patch('framework.xcyber360.core.batcher.mux_demux.MuxDemuxRunner')
