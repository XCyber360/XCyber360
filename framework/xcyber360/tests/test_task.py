...
with patch('xcyber360.common.xcyber360_uid'):
    with patch('xcyber360.common.xcyber360_gid'):
        ...
        from xcyber360.tests.util import get_fake_database_data, RBAC_bypasser, InitWDBSocketMock

        xcyber360.rbac.decorators.expose_resources = RBAC_bypasser
        from xcyber360 import task, Xcyber360Error
...
@patch('xcyber360.core.utils.Xcyber360DBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(Xcyber360DBQueryTask, '_final_query', fake_final_query)
