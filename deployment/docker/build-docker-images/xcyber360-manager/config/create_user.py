...
try:
    ...
    from xcyber360.security import (
        create_user,
        get_users,
        get_roles,
        set_user_role,
    ...
    logging.error("No module 'xcyber360' found.")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if username not in initial_users:
        ...
        # modify an existing user ("xcyber360" or "xcyber360-wui")
    ...
    for def_user in ['xcyber360', 'xcyber360-wui']:
