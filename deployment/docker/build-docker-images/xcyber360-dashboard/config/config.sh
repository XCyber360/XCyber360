...
export NAME=xcyber360-dashboard
...
# Copy Xcyber360 dashboard certs to install config dir
cp /xcyber360-certificates/dashboard.pem ${CONFIG_DIR}/certs/dashboard.pem
cp /xcyber360-certificates/dashboard-key.pem ${CONFIG_DIR}/certs/dashboard-key.pem
cp /xcyber360-certificates/root-ca.pem ${CONFIG_DIR}/certs/root-ca.pem
