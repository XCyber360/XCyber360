...
systemConfig() {
  ...
  mv ${CUSTOM_PATH}/grub/xcyber360.png /boot/grub2/
  ...
  # Update Xcyber360 indexer jvm heap
  ...
  # Change root password (root:xcyber360)
  ...
  bash ${CUSTOM_PATH}/messages.sh ${DEBUG} ${XCYBER360_VERSION} ${SYSTEM_USER}
