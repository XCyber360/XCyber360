...
import { getCore, getXcyber360Core } from '../plugin-services';
import { AvailableUpdates } from '../../../xcyber360-check-updates/common/types';
...
export const UpdatesNotification = () => {
  ...
  const sideNavDocked = getXcyber360Core().hooks.useDockedSideNav();
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <EuiText>
                  <FormattedMessage
                    id='xcyber360CheckUpdates.updatesNotification.message'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <RedirectAppLinks application={getCore().application}>
                  ...
                  >
                    <FormattedMessage
                      id='xcyber360CheckUpdates.updatesNotification.linkText'
            ...
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false}>
                <EuiCheckbox
                  ...
                  label={
                    <FormattedMessage
                      id='xcyber360CheckUpdates.updatesNotification.dismissCheckText'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                ...
                >
                  <FormattedMessage
                    id='xcyber360CheckUpdates.updatesNotification.closeButtonText'
