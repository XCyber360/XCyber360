...
describe('Error Handler', () => {
  ...
  describe('createError', () => {
    ...
    it.each([
      ...
      {
        name: 'Xcyber360ApiError',
        message: 'Error Xcyber360ApiError',
        url: '/api/request',
      },
      {
        name: 'Xcyber360ReportingError',
        message: 'Error Xcyber360ReportingError',
        url: '/reports',
      },
      {
        name: 'HttpError',
  ...
  describe('handleError', () => {
    ...
    it.each([
      ...
      ({
        ...
        if (errorHandled instanceof Xcyber360Error) {
    ...
    it.each([
      ...
      ({
        ...
        expect(errorFromHandler).toBeInstanceOf(
          ErrorType ? ErrorType : Xcyber360Error,
        );
