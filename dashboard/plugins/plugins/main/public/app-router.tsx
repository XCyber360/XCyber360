...
import {
  ...
  getXcyber360EnginePlugin,
  getXcyber360FleetPlugin,
  getWzMainParams,
...
import { Xcyber360FlyoutDiscover } from './components/common/xcyber360-discover/wz-flyout-discover';
import {
  FILTER_OPERATOR,
  PatternDataSource,
...
import DocDetails from './components/common/xcyber360-discover/components/doc-details';
...
import { DocumentViewTableAndJson } from './components/common/xcyber360-discover/components/document-view-table-and-json';
...
export function Application(props) {
  ...
  const { FleetManagement } = getXcyber360FleetPlugin();
  ...
  return (
    <Router history={history}>
      <div className='xcyber360NotReadyYet'></div>
      ...
      <Switch>
        ...
        <Route
          path={'/engine'}
          render={props => {
            const { Engine } = getXcyber360EnginePlugin();
            return (
              <Engine
                navigationService={NavigationService}
                ...
                Xcyber360FlyoutDiscover={Xcyber360FlyoutDiscover}
