...
- AQL: API Query Language. Based on https://documentation.xcyber360.com/current/user-manual/api/queries.html.
...
Its syntax is equal to Xcyber360 API Query Language
https://xcyber360.com/<major_version>.<minor_version>/user-manual/api/queries.html
