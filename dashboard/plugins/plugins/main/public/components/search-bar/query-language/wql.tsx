...
/* UI Query language
https://documentation.xcyber360.com/current/user-manual/api/queries.html
...
export const WQL = {
  ...
  label: 'WQL',
  description:
    'WQL (Xcyber360 Query Language) provides a human query syntax based on the Xcyber360 API query language.',
  documentationLink: webDocumentationLink(
    'user-manual/xcyber360-dashboard/queries.html',
  ),
  getConfiguration() {
    return {
