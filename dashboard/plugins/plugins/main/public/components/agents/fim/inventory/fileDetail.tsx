/*
 * Xcyber360 app - Integrity monitoring table component
...
import { Xcyber360FlyoutDiscover } from '../../../common/xcyber360-discover/wz-flyout-discover';
import {
  FILTER_OPERATOR,
  PatternDataSource,
