...
const getVisStateEventsBySeverity = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Rule-Level-Histogram',
...
const getVisStateIPsByUser = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-IPs-By-User-Barchart',
...
const getVisStateTopUserBySubcription = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Top-Users-By-Subscription-Barchart',
...
const getVisStateUsersByOperationResult = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-User-By-Operation-Result',
...
const getVisStateSeverityByUser = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Severity-By-User-Barchart',
...
const getVisStateRuleDescription = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Rule-Description-Level-Table',
...
const getVisStateOfficeMap = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-Office-Location',
