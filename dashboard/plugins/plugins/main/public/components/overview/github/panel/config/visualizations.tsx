export const getVisStateTopActions = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Top-Ten-Actions',
...
export const getVisStateTopRepositories = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Top-Ten-Repositories',
...
export const getVisStateTopCountries = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Countries',
    title: 'Countries',
    type: 'tagcloud',
    params: {
      scale: 'linear',
...
export const getVisStateRuleLevelEvolution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GitHub-Alert-Level-Evolution',
