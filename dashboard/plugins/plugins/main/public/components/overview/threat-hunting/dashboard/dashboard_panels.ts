...
const getVisStateTop10AlertLevelEvolution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Alert-level-evolution',
...
const getVisStateTop5Agents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Top-5-agents',
    title: 'Top 5 agents',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateTop10MITREATTACKS = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Alerts-Top-Mitre',
...
const getVisStateAlertEvolutionTop5Agents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Alerts-evolution-Top-5-agents',
...
const getVisStatePinnedAgentTop10AlertGroupsEvolution = (
  ...
  return {
    id: 'Xcyber360-App-Agents-General-Alert-groups-evolution',
...
const getVisStateAlertsAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-General-Alerts',
    title: 'Alerts',
    type: 'area',
    params: {
      type: 'area',
...
const getVisStateTop5AlertsAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-General-Top-5-alerts',
    title: 'Top 5 alerts',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateTop5RuleGroupsAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-General-Top-10-groups',
...
const getVisStateTop5PCIDSSRequirementsAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-General-Top-5-PCI-DSS-Requirements',
