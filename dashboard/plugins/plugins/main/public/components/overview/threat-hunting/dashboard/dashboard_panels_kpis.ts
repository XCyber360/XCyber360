...
const getVisStateTotal = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Metric-alerts',
    title: 'Total',
    type: 'metric',
    params: {
      addTooltip: true,
...
const getVisStateLevel12Alerts = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Level-12-alerts',
...
const getVisStateAuthenticationFailure = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Authentication-failure',
...
const getVisStateAuthenticationSuccess = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-General-Authentication-success',
