...
const getVisStateAlertsVolumeByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Heatmap',
...
const getVisStateTagsCloud = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Tag-cloud',
...
const getVisStateTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Top-10-requirements',
...
const getVisStateMostActiveAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Top-10-agents',
...
const getVisStateStats = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Metrics',
    title: 'Stats',
    type: 'metric',
    params: {
      metric: {
...
const getVisStateRequirementsOverTime2 = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Top-requirements-over-time',
...
const getVisStateRequirementDistributionByAgent = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-HIPAA-Top-10-requirements-over-time-by-agent',
...
const getVisStateAgentRequirementsOvertime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-HIPAA-Requirements-Stacked-Overtime',
...
const getVisStateAgentTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-HIPAA-top-10',
    title: 'Top 10 requirements',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-HIPAA-Bubbles',
...
const getVisStateAgentRuleLevelDistribution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-HIPAA-Distributed-By-Level',
...
const getVisStateAgentCommonAlerts = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-HIPAA-Most-Common',
    title: 'Most common alerts',
    type: 'tagcloud',
    params: {
      scale: 'linear',
