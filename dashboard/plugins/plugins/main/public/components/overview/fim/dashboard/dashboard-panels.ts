...
const getVisStateFIMAlertsByActionOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-Alerts-by-action-over-time',
...
const getVisStateFIMTopAgentsPie = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-Top-5-agents-pie',
    title: 'Top 5 agents',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateFIMEventsSummary = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-Events-summary',
...
const getVisStateFIMTopRules = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-Top-5-rules',
...
const getVisStateFIMCommonActions = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-Common-actions',
    title: 'Actions',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateFIMTopAgentsUser = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-FIM-top-agents-user',
    title: 'Top 5 users',
    type: 'table',
    params: {
      perPage: 5,
...
const getVisStateAgentFIMUsers = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Users',
...
const getVisStateAgentFIMActions = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Actions',
    title: 'Actions',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentFIMEvents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Events',
    title: 'Events',
    type: 'line',
    params: {
      type: 'line',
...
const getVisStateAgentFIMFilesAdded = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Files-added',
    title: 'Files added',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentFIMFilesModified = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Files-modified',
...
const getVisStateAgentFIMFilesDeleted = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-FIM-Files-deleted',
    title: 'Files deleted',
    type: 'pie',
    params: {
      type: 'pie',
