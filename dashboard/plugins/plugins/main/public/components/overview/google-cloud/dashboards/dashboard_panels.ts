...
const getVisStateEventsOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GCP-Alerts-Evolution-By-AuthAnswer',
...
const getVisStateTopResponseCode = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GCP-Top-vmInstances-By-ResponseCode',
...
const getVisStateTopResourceTypeProject = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GCP-Top-ResourceType-By-Project-Id',
...
const getVisStateTopProjectIdBySource = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GCP-Top-ProjectId-By-SourceType',
...
const getVisStateTop5Map = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-GCP-Map-By-SourceIp',
...
const getVisStateTop5Rules = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GCP-Top-5-rules',
    title: 'Top 5 rules',
    type: 'table',
    params: {
      perPage: 10,
...
const getVisStateTopQueryEvents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GCP-Event-Query-Name',
...
const getVisStateTop5Instances = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GCP-Top-5-instances',
...
const getVisStateGCPAlerts = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GCP-Events-Over-Time',
...
const getVisStateGCPAuthAnswer = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-GCP-authAnswer-Bar',
