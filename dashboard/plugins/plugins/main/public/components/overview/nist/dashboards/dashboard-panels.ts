...
const getVisStateMostActiveAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-Agents',
...
const getVisStateRequirementsOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-Requirements-over-time',
...
const getVisStateRequirementsByAgents = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-requirements-by-agents',
...
const getVisStateRequirementsAgentsHeatmap = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-Requirements-Agents-heatmap',
...
const getVisStateMetrics = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-Metrics',
    title: 'Stats',
    type: 'metric',
    params: {
      metric: {
...
const getVisStateTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Overview-NIST-Top-10-requirements',
...
const getVisStateAgentStats = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-NIST-Stats',
    title: 'Stats',
    type: 'metric',
    params: {
      metric: {
...
const getVisStateAgentTopRequirements = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-NIST-top-10-requirements',
    title: 'Top 10 requirements',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAgentRuleLevelDistribution = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-NIST-Requirement-by-level',
...
const getVisStateAgentRequirementsOverTime = (indexPatternId: string) => {
  return {
    id: 'Xcyber360-App-Agents-NIST-Requirements-stacked-overtime',
