...
export const VisualizationBasic = ({
  ...
  if (isLoading) {
    ...
    visualization = (
      <EuiFlexGroup
        ...
        gutterSize='none'
      >
        <EuiFlexItem className={'xcyber360-visualization-chart'}>
          <Chart data={data} />
        </EuiFlexItem>
        {showLegend && (
          <EuiFlexItem className={'xcyber360-visualization-legend'}>
            <ChartLegend
  ...
  return (
    <div style={{ width, height }} className='xcyber360-visualization-layout'>
      {visualization}
    </div>
  );
};
