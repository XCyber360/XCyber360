...
const OutdatedAgentsCard = ({
  ...
  const renderMetric = () => {
    return (
      <div className='xcyber360-outdated-agents-panel' onClick={onShowOptions}>
        <EuiIcon
          type={contentIcon}
          color={contentType}
          className='xcyber360-outdated-icon'
        />
        <EuiStat
          className='xcyber360-outdated-metric'
          title={
            <EuiTextColor
              data-testid='xcyber360-endpoints-summary-outdated-agents-number'
              color={contentType}
            >
              {outdatedAgents}
            </EuiTextColor>
            ...
            <EuiTextColor color='subdued'>
              <EuiLink
                href={webDocumentationLink(
                  'upgrade-guide/xcyber360-agent/index.html',
                )}
                target='_blank'
                external
