...
import {
  ...
  Xcyber360VersionUndefinedException,
} from '../exceptions';
...
export type tOptionalParameters = 'server_address' | 'agent_name' | 'agent_group' | 'protocol' | 'xcyber360_password' | 'another_optional_parameter';
...
describe('getInstallCommandByOS', () => {
  ...
  it('should return install command with optional parameters', () => {
    ...
    const optionalParams: IOptionalParameters<tOptionalParameters> = {
      agent_group: 'XCYBER360_GROUP=agent_group',
      agent_name: 'XCYBER360_NAME=agent_name',
      protocol: 'XCYBER360_PROTOCOL=UDP',
      server_address: 'XCYBER360_MANAGER=server_address',
      xcyber360_password: 'XCYBER360_PASSWORD=1231323',
