import { scapeSpecialCharsForLinux, scapeSpecialCharsForMacOS, scapeSpecialCharsForWindows } from './xcyber360-password-service';
describe('Xcyber360 Password Service', () => {
  // NOTE:
