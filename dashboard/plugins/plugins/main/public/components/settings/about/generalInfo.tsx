            ...
            >
              <EuiFlexItem grow={false}>
                <EuiButtonIcon
                  ...
                  iconType='logoSlack'
                  iconSize='xxl'
                  href='https://xcyber360.com/community/join-us-on-slack/'
                  target='_blank'
                >
                  Slack
                </EuiButtonIcon>
              ...
              <EuiFlexItem grow={false}>
                <EuiButtonIcon
                  ...
                  iconSize='xxl'
                  href='https://groups.google.com/forum/#!forum/xcyber360'
                  target='_blank'
                >
                  Google groups
                </EuiButtonIcon>
              ...
              <EuiFlexItem grow={false}>
                <EuiButtonIcon
                  ...
                  iconType='logoGithub'
                  iconSize='xxl'
                  href='https://github.com/xcyber360/xcyber360-kibana-app'
                  target='_blank'
                >
                  Github
                </EuiButtonIcon>
