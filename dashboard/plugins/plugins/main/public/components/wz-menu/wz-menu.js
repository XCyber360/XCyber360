/*
 * Xcyber360 app - React component for build q queries.
...
export const WzMenu = withWindowSize(
  class WzMenu extends Component {
    constructor(props) {
      ...
      this.xcyber360Config = new Xcyber360Config();
    ...
    changeAPI = async event => {
      try {
        ...
        if (this.state.currentMenuTab !== 'xcyber360-dev') {
    ...
    buildXcyber360NotReadyYet() {
      const container = document.getElementsByClassName('xcyber360NotReadyYet');
      return ReactDOM.createPortal(
        <EuiCallOut title={this.props.state.xcyber360NotReadyYet} color='warning'>
          <EuiFlexGroup
            responsive={false}
            direction='row'
          ...
          >
            ...
            {typeof this.props.state.xcyber360NotReadyYet === 'string' &&
              this.props.state.xcyber360NotReadyYet.includes('Restarting') && (
            ...
            {this.props.state.xcyber360NotReadyYet ===
        ...
        <>
          <MountPointPortal setMountPoint={getHeaderActionMenuMounter()}>
            ...
            >
              ...
              {this.props.state.xcyber360NotReadyYet &&
                this.buildXcyber360NotReadyYet()}
            </EuiFlexGroup>
          </MountPointPortal>
        </>
      );
