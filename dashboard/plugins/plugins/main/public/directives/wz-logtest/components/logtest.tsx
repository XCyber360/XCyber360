/*
 * Xcyber360 app - React component for Logtest.
...
export const Logtest = compose(
  ...
  // Format the result of the Xcyber360 API response to an output similar one to the `xcyber360-logtest` utility
  const formatResult = (result, alert, messages) => {
    // How to the `xcyber360-logtest` utility logs the output:
    // https://github.com/xcyber360/xcyber360/blob/master/framework/scripts/xcyber360-logtest.py#L359-L397
    ...
    // Rule debugging
    // The output has data if the utility is ran in verbose mode: `xcyber360-logtest -v`.
    // At this moment, the Xcyber360 API doesn't let run in verbose mode.
