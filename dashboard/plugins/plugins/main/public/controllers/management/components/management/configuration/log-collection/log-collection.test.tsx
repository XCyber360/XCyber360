...
const linuxAgentMocked = {
  os: {
    ...
    platform: 'ubuntu',
    uname:
      'Linux |xcyber360_agent_ubuntu_sources_cmake-v4.3.4-rc1 |5.10.104-linuxkit |#1 SMP Thu Mar 17 17:08:06 UTC 2022 |x86_64',
    version: '18.04.6 LTS',
  },
  group: ['default'],
  status: 'active',
  ...
  registerIP: 'any',
  name: 'xcyber360_agent_ubuntu_sources_cmake-v4.3.4-rc1',
  version: 'Xcyber360 v4.3.4',
  id: '001',
  ip: '172.18.0.5',
