/*
 * Xcyber360 app - App State Reducers
...
const appStateReducers = (state = initialState, action) => {
  ...
  if (action.type === 'UPDATE_XCYBER360_NOT_READY_YET') {
    return {
      ...state,
      xcyber360NotReadyYet: action.xcyber360NotReadyYet,
    };
  }

  if (action.type === 'UPDATE_XCYBER360_CURRENT_TAB') {
    return {
      ...state,
