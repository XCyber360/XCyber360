# Xcyber360 dashboard app

This folder contains the Xcyber360 dashboard plugin, from which you can navigate through the
Xcyber360 data using visualizations in a simple and understandable way. It also allows you to
manage the configuration and capabilities of the Xcyber360 server.

## Description

This plugin for Xcyber360 dashboard allows you to visualize and analyze Xcyber360 alerts stored in
the Xcyber360 Indexer. The plugin provides the following capabilities:

- Search alerts classified by modules and filter them using the different views. You will be able to explore the alerts both at Xcyber360 cluster level, and in a particular agent. The modules, divided into the following use cases, are:
