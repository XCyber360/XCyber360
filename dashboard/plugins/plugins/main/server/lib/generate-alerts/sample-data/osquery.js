/*
 * Xcyber360 app - Osquery sample alerts
  ...
  },
  {
    osquery: {
      ...
      columns: {
        ...
        executions: '177',
        output_size: '0',
        name: 'pack_server-rootkit_zk_rootkit',
        interval: '3600',
        avg_user_time: '0',
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: osquery-monitoring schedule: The pack executed is pack_server-rootkit_zk_rootkit and the interval is 3600 ',
    },
  },
  {
    osquery: {
