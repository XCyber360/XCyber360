import md5 from 'md5';
import fs from 'fs';
import { Xcyber360ReportingCtrl } from './xcyber360-reporting';
...
const endpointController = new Xcyber360ReportingCtrl();
...
describe('[security] Report endpoints guard related to a file. Parameter defines or builds the filename.', () => {
  ...
  it.each`
    ...
    ${'Execute endpoint handler'} | ${'admin'}     | ${'xcyber360-module-overview-general-1234.pdf'}          | ${false}
    ${'Endpoint protected'}       | ${'admin'}     | ${'../xcyber360-module-overview-general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'xcyber360-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'custom../xcyber360-module-overview-general-1234.pdf'} | ${true}
    ${'Execute endpoint handler'} | ${'../../etc'} | ${'xcyber360-module-agents-001-general-1234.pdf'}        | ${false}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'../xcyber360-module-agents-001-general-1234.pdf'}     | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'xcyber360-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'custom../xcyber360-module-overview-general-1234.pdf'} | ${true}
  `(
    `$testTitle
	username: $username
	filename: $filename
...
describe('[security] GET /reports/{name}', () => {
  it.each`
    ...
    ${'Get report'}         | ${'admin'}     | ${'xcyber360-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../xcyber360-module-overview-1234.pdf'} | ${false}
    ${'Get report'}         | ${'../../etc'} | ${'xcyber360-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../xcyber360-module-overview-1234.pdf'} | ${false}
  `(
    ...
    async ({ username, moduleID, valid }) => {
      ...
      if (valid) {
        ...
        expect(response.body.message).toMatch(
          new RegExp(`Report xcyber360-module-overview-${moduleID}`),
        );
      } else {
        expect(response.body.message).toBe('5040 - You shall not pass!');
      }
...
describe('[security] DELETE /reports/<filename>', () => {
  ...
  it.each`
    titleTest               | username       | filename                                     | valid
    ${'Delete report'}      | ${'admin'}     | ${'xcyber360-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../xcyber360-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'admin'}     | ${'custom../xcyber360-module-overview-1234.pdf'} | ${false}
    ${'Delete report'}      | ${'../../etc'} | ${'xcyber360-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../xcyber360-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'../../etc'} | ${'custom../xcyber360-module-overview-1234.pdf'} | ${false}
  `(
