// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/xcyber360-api
...
describe.skip('Xcyber360 API', () => {
  describe('Xcyber360 API - /api/login', () => {
  ...
  describe('Xcyber360 API - /api/check-api', () => {
      ...
      return axios(options).catch(error => {
        ...
        expect(
          error.response.data.message.includes(
            'Selected API is no longer available in xcyber360.yml',
          ),
        ).toBe(true);
      });
    });
  ...
  describe('Xcyber360 API - /api/check-stored-api', () => {
    test('[200] Check default api returns manager, node, cluster, status and allow_run_as params', () => {
  ...
  describe('Xcyber360 API - /api/request', () => {
    let userToken = null;
    beforeAll(() => {
  ...
  describe('Xcyber360 API - /api/routes', () => {
  ...
  describe('Xcyber360 API - /api/setup', () => {
  ...
  describe('Xcyber360 API - /api/syscollector', () => {
