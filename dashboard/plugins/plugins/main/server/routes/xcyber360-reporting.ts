/*
 * Xcyber360 app - Module for Xcyber360 reporting routes
 ...
 */
import { Xcyber360ReportingCtrl } from '../controllers';
import { IRouter } from 'opensearch_dashboards/server';
import { schema } from '@osd/config-schema';

export function Xcyber360ReportingRoutes(router: IRouter) {
  const ctrl = new Xcyber360ReportingCtrl();
