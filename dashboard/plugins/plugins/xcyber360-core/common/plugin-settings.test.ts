...
describe('[settings] Input validation', () => {
  it.each`
    ...
    ${'timeout'}                        | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.creation'}      | ${'h'}                                                                 | ${undefined}
    ${'xcyber360.monitoring.creation'}      | ${'d'}                                                                 | ${undefined}
    ${'xcyber360.monitoring.creation'}      | ${'w'}                                                                 | ${undefined}
    ${'xcyber360.monitoring.creation'}      | ${'m'}                                                                 | ${undefined}
    ${'xcyber360.monitoring.creation'}      | ${'test'}                                                              | ${'Invalid value. Allowed values: h, d, w, m.'}
    ${'xcyber360.monitoring.enabled'}       | ${true}                                                                | ${undefined}
    ${'xcyber360.monitoring.frequency'}     | ${100}                                                                 | ${undefined}
    ${'xcyber360.monitoring.frequency'}     | ${40}                                                                  | ${'Value should be greater or equal than 60.'}
    ${'xcyber360.monitoring.frequency'}     | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.frequency'}     | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test'}                                                              | ${undefined}
    ${'xcyber360.monitoring.pattern'}       | ${'test*'}                                                             | ${undefined}
    ${'xcyber360.monitoring.pattern'}       | ${''}                                                                  | ${'Value can not be empty.'}
    ${'xcyber360.monitoring.pattern'}       | ${'-test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'xcyber360.monitoring.pattern'}       | ${'_test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'xcyber360.monitoring.pattern'}       | ${'+test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'xcyber360.monitoring.pattern'}       | ${'.test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'xcyber360.monitoring.pattern'}       | ${'test\\'}                                                            | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test/'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test?'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test"'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test<'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'xcyber360.monitoring.pattern'}       | ${'test,'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.pattern'}       | ${'test#'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'xcyber360.monitoring.replicas'}      | ${0}                                                                   | ${undefined}
    ${'xcyber360.monitoring.replicas'}      | ${-1}                                                                  | ${'Value should be greater or equal than 0.'}
    ${'xcyber360.monitoring.replicas'}      | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.replicas'}      | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.shards'}        | ${1}                                                                   | ${undefined}
    ${'xcyber360.monitoring.shards'}        | ${-1}                                                                  | ${'Value should be greater or equal than 1.'}
    ${'xcyber360.monitoring.shards'}        | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'xcyber360.monitoring.shards'}        | ${1.2}                                                                 | ${'Number should be an integer.'}
