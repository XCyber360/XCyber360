/*
 * Xcyber360 app - Xcyber360 Constants file
...
// Index patterns - Xcyber360 alerts
export const XCYBER360_INDEX_TYPE_ALERTS = 'alerts';
export const XCYBER360_ALERTS_PREFIX = 'xcyber360-alerts-';
export const XCYBER360_ALERTS_PATTERN = 'xcyber360-alerts-*';

// Job - Xcyber360 monitoring
export const XCYBER360_INDEX_TYPE_MONITORING = 'monitoring';
export const XCYBER360_MONITORING_PREFIX = 'xcyber360-monitoring-';
export const XCYBER360_MONITORING_PATTERN = 'xcyber360-monitoring-*';
export const XCYBER360_MONITORING_TEMPLATE_NAME = 'xcyber360-agent';
export const XCYBER360_MONITORING_DEFAULT_INDICES_SHARDS = 1;
export const XCYBER360_MONITORING_DEFAULT_INDICES_REPLICAS = 0;
export const XCYBER360_MONITORING_DEFAULT_CREATION = 'w';
export const XCYBER360_MONITORING_DEFAULT_ENABLED = true;
export const XCYBER360_MONITORING_DEFAULT_FREQUENCY = 900;
export const XCYBER360_MONITORING_DEFAULT_CRON_FREQ = '0 * * * * *';

// Job - Xcyber360 statistics
export const XCYBER360_INDEX_TYPE_STATISTICS = 'statistics';
export const XCYBER360_STATISTICS_DEFAULT_PREFIX = 'xcyber360';
export const XCYBER360_STATISTICS_DEFAULT_NAME = 'statistics';
export const XCYBER360_STATISTICS_PATTERN = `${XCYBER360_STATISTICS_DEFAULT_PREFIX}-${XCYBER360_STATISTICS_DEFAULT_NAME}-*`;
export const XCYBER360_STATISTICS_TEMPLATE_NAME = `${XCYBER360_STATISTICS_DEFAULT_PREFIX}-${XCYBER360_STATISTICS_DEFAULT_NAME}`;
export const XCYBER360_STATISTICS_DEFAULT_INDICES_SHARDS = 1;
export const XCYBER360_STATISTICS_DEFAULT_INDICES_REPLICAS = 0;
export const XCYBER360_STATISTICS_DEFAULT_CREATION = 'w';
export const XCYBER360_STATISTICS_DEFAULT_STATUS = true;
export const XCYBER360_STATISTICS_DEFAULT_FREQUENCY = 900;
export const XCYBER360_STATISTICS_DEFAULT_CRON_FREQ = '0 */5 * * * *';

// Xcyber360 vulnerabilities
export const XCYBER360_VULNERABILITIES_PATTERN = 'xcyber360-states-vulnerabilities-*';
export const XCYBER360_INDEX_TYPE_VULNERABILITIES = 'vulnerabilities';

// Job - Xcyber360 initialize
export const XCYBER360_PLUGIN_PLATFORM_TEMPLATE_NAME = 'xcyber360-kibana';

// Sample data
export const XCYBER360_SAMPLE_ALERT_PREFIX = 'xcyber360-alerts-4.x-';
export const XCYBER360_SAMPLE_ALERTS_INDEX_SHARDS = 1;
export const XCYBER360_SAMPLE_ALERTS_INDEX_REPLICAS = 0;
export const XCYBER360_SAMPLE_ALERTS_CATEGORY_SECURITY = 'security';
export const XCYBER360_SAMPLE_ALERTS_CATEGORY_AUDITING_POLICY_MONITORING =
  'auditing-policy-monitoring';
export const XCYBER360_SAMPLE_ALERTS_CATEGORY_THREAT_DETECTION = 'threat-detection';
export const XCYBER360_SAMPLE_ALERTS_DEFAULT_NUMBER_ALERTS = 3000;
export const XCYBER360_SAMPLE_ALERTS_CATEGORIES_TYPE_ALERTS = {
...
// Security
export const XCYBER360_SECURITY_PLUGIN_OPENSEARCH_DASHBOARDS_SECURITY =
  'OpenSearch Dashboards Security';

export const XCYBER360_SECURITY_PLUGINS = [
  XCYBER360_SECURITY_PLUGIN_OPENSEARCH_DASHBOARDS_SECURITY,
];

// App configuration
export const XCYBER360_CONFIGURATION_CACHE_TIME = 10000; // time in ms;

// Reserved ids for Users/Role mapping
export const XCYBER360_API_RESERVED_ID_LOWER_THAN = 100;
export const XCYBER360_API_RESERVED_WUI_SECURITY_RULES = [1, 2];

// Xcyber360 data path
const XCYBER360_DATA_PLUGIN_PLATFORM_BASE_PATH = 'data';
export const XCYBER360_DATA_PLUGIN_PLATFORM_BASE_ABSOLUTE_PATH = path.join(
  __dirname,
  '../../../',
  XCYBER360_DATA_PLUGIN_PLATFORM_BASE_PATH,
);
export const XCYBER360_DATA_ABSOLUTE_PATH = path.join(
  XCYBER360_DATA_PLUGIN_PLATFORM_BASE_ABSOLUTE_PATH,
  'xcyber360',
);

// Xcyber360 data path - config
export const XCYBER360_DATA_CONFIG_DIRECTORY_PATH = path.join(
  XCYBER360_DATA_ABSOLUTE_PATH,
  'config',
);
export const XCYBER360_DATA_CONFIG_REGISTRY_PATH = path.join(
  XCYBER360_DATA_CONFIG_DIRECTORY_PATH,
  'xcyber360-registry.json',
);

export const XCYBER360_DATA_CONFIG_APP_PATH = path.join(
  XCYBER360_DATA_CONFIG_DIRECTORY_PATH,
  'xcyber360.yml',
);

// Xcyber360 data path - downloads
export const XCYBER360_DATA_DOWNLOADS_DIRECTORY_PATH = path.join(
  XCYBER360_DATA_ABSOLUTE_PATH,
  'downloads',
);
export const XCYBER360_DATA_DOWNLOADS_REPORTS_DIRECTORY_PATH = path.join(
  XCYBER360_DATA_DOWNLOADS_DIRECTORY_PATH,
  'reports',
);

// Queue
export const XCYBER360_QUEUE_CRON_FREQ = '*/15 * * * * *'; // Every 15 seconds

// Xcyber360 errors
export const XCYBER360_ERROR_DAEMONS_NOT_READY = 'ERROR3099';

// Agents
export enum XCYBER360_AGENTS_OS_TYPE {
  WINDOWS = 'windows',
  LINUX = 'linux',
  SUNOS = 'sunos',
  DARWIN = 'darwin',
...
export enum XCYBER360_MODULES_ID {
...
export enum XCYBER360_MENU_MANAGEMENT_SECTIONS_ID {
...
export enum XCYBER360_MENU_TOOLS_SECTIONS_ID {
  API_CONSOLE = 'devTools',
  RULESET_TEST = 'logtest',
}

export enum XCYBER360_MENU_SECURITY_SECTIONS_ID {
  USERS = 'users',
  ROLES = 'roles',
  POLICIES = 'policies',
...
export enum XCYBER360_MENU_SETTINGS_SECTIONS_ID {
  SETTINGS = 'settings',
...
// Xcyber360 links
export const XCYBER360_LINK_GITHUB = 'https://github.com/xcyber360';
export const XCYBER360_LINK_GOOGLE_GROUPS =
  'https://groups.google.com/forum/#!forum/xcyber360';
export const XCYBER360_LINK_SLACK = 'https://xcyber360.com/community/join-us-on-slack';
...
export const XCYBER360_PLUGIN_PLATFORM_SETTING_TIME_FILTER = {
  from: 'now-24h',
  to: 'now',
};
...
export const XCYBER360_PLUGIN_PLATFORM_SETTING_MAX_BUCKETS = 200000;
export const PLUGIN_PLATFORM_SETTING_NAME_MAX_BUCKETS = 'timeline:max_buckets';

// Default metaFields set by the app
export const XCYBER360_PLUGIN_PLATFORM_SETTING_METAFIELDS = ['_source', '_index'];
...
// Assets
export const ASSETS_BASE_URL_PREFIX = '/plugins/xcyber360/assets/';
export const ASSETS_PUBLIC_URL = '/plugins/xcyber360/public/assets/';

// Reports
export const REPORTS_LOGO_IMAGE_ASSETS_RELATIVE_PATH =
  'images/logo_reports.png';
export const REPORTS_PRIMARY_COLOR = '#256BD1';
export const REPORTS_PAGE_FOOTER_TEXT = 'Copyright © 2023 Xcyber360, Inc.';
export const REPORTS_PAGE_HEADER_TEXT = 'info@xcyber360.com\nhttps://xcyber360.com';

// Plugin platform
export const PLUGIN_PLATFORM_NAME = 'dashboard';
export const PLUGIN_PLATFORM_INSTALLATION_USER = 'xcyber360-dashboard';
export const PLUGIN_PLATFORM_INSTALLATION_USER_GROUP = 'xcyber360-dashboard';
export const PLUGIN_PLATFORM_XCYBER360_DOCUMENTATION_URL_PATH_UPGRADE_PLATFORM =
  'upgrade-guide';
export const PLUGIN_PLATFORM_XCYBER360_DOCUMENTATION_URL_PATH_TROUBLESHOOTING =
  'user-manual/xcyber360-dashboard/troubleshooting.html';
export const PLUGIN_PLATFORM_XCYBER360_DOCUMENTATION_URL_PATH_APP_CONFIGURATION =
  'user-manual/xcyber360-dashboard/config-file.html';
...
// The status code can be seen here https://github.com/xcyber360/xcyber360/blob/686068a1f05d806b2e3b3d633a765320ae7ae114/src/xcyber360_db/wdb.h#L55-L61
...
// Documentation
export const DOCUMENTATION_WEB_BASE_URL = 'https://documentation.xcyber360.com';

// Default Elasticsearch user name context
export const ELASTIC_NAME = 'elastic';

// Default Xcyber360 indexer name
export const XCYBER360_INDEXER_NAME = 'indexer';
...
export const PLUGIN_SETTINGS_CATEGORIES: {
  ...
  [SettingCategory.CUSTOMIZATION]: {
    ...
    documentationLink: 'user-manual/xcyber360-dashboard/white-labeling.html',
...
export const PLUGIN_SETTINGS: { [key: string]: TPluginSetting } = {
  'alerts.sample.prefix': {
    ...
    defaultValue: XCYBER360_SAMPLE_ALERT_PREFIX,
  ...
  'cron.prefix': {
    ...
    category: SettingCategory.GENERAL,
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_STATISTICS_DEFAULT_PREFIX,
    isConfigurableFromSettings: true,
    validateUIForm: function (value) {
      return this.validate(value);
    },
  ...
  'cron.statistics.index.creation': {
    ...
    defaultValue: XCYBER360_STATISTICS_DEFAULT_CREATION,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cron.statistics.index.name': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_STATISTICS_DEFAULT_NAME,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cron.statistics.index.replicas': {
    ...
    defaultValue: XCYBER360_STATISTICS_DEFAULT_INDICES_REPLICAS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'cron.statistics.index.shards': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.number,
    defaultValue: XCYBER360_STATISTICS_DEFAULT_INDICES_SHARDS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'cron.statistics.interval': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_STATISTICS_DEFAULT_CRON_FREQ,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
  ...
  'cron.statistics.status': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.switch,
    defaultValue: XCYBER360_STATISTICS_DEFAULT_STATUS,
    isConfigurableFromSettings: true,
    options: {
      switch: {
        values: {
  ...
  'customization.logo.app': {
    title: 'App main logo',
    description: `This logo is used as loading indicator while the user is logging into Xcyber360 API.`,
    store: {
      file: {
        configurableManaged: true,
      },
  ...
  'enrollment.dns': {
    ...
    description:
      'Specifies the Xcyber360 registration server, used for the agent enrollment.',
    store: {
      file: {
        configurableManaged: true,
      },
...
#       port: 55000
#       # Host / API username
#       username: xcyber360-wui
#       # Host / API password
#       password: xcyber360-wui
#       # Use RBAC or not. If set to true, the username must be "xcyber360-wui".
#       run_as: true
#   - env-2:
...
hosts:
  ...
  pattern: {
    ...
    category: SettingCategory.GENERAL,
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_ALERTS_PATTERN,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    // Validation: https://github.com/elastic/elasticsearch/blob/v7.10.2/docs/reference/indices/create-index.asciidoc
    validateUIForm: function (value) {
  ...
  'xcyber360.monitoring.creation': {
    title: 'Index creation',
    description:
      'Define the interval in which a new xcyber360-monitoring index will be created.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    defaultValue: XCYBER360_MONITORING_DEFAULT_CREATION,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'xcyber360.monitoring.enabled': {
    title: 'Status',
    description:
      'Enable or disable the xcyber360-monitoring index creation and/or visualization.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.switch,
    defaultValue: XCYBER360_MONITORING_DEFAULT_ENABLED,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
    options: {
      switch: {
  ...
  'xcyber360.monitoring.frequency': {
    title: 'Frequency',
    description:
      'Frequency, in seconds, of API requests to get the state of the agents and create a new document in the xcyber360-monitoring index with this data.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: XCYBER360_MONITORING_DEFAULT_FREQUENCY,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
    options: {
      number: {
  ...
  'xcyber360.monitoring.pattern': {
    title: 'Index pattern',
    description: 'Default index pattern to use for Xcyber360 monitoring.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_MONITORING_PATTERN,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'xcyber360.monitoring.replicas': {
    title: 'Index replicas',
    description:
      'Define the number of replicas to use for the xcyber360-monitoring-* indices.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: XCYBER360_MONITORING_DEFAULT_INDICES_REPLICAS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'xcyber360.monitoring.shards': {
    title: 'Index shards',
    description:
      'Define the number of shards to use for the xcyber360-monitoring-* indices.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: XCYBER360_MONITORING_DEFAULT_INDICES_SHARDS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'vulnerabilities.pattern': {
    ...
    type: EpluginSettingType.text,
    defaultValue: XCYBER360_VULNERABILITIES_PATTERN,
    isConfigurableFromSettings: true,
...
// Plugin settings
export const XCYBER360_CORE_ENCRYPTION_PASSWORD = 'secretencryptionkey!';

// Configuration backend service
export const XCYBER360_CORE_CONFIGURATION_INSTANCE = 'xcyber360-dashboard';
export const XCYBER360_CORE_CONFIGURATION_CACHE_SECONDS = 10;

// API connection permissions
export const XCYBER360_ROLE_ADMINISTRATOR_ID = 1;
