...
# Database support for Xcyber360 HIDS.
# Copyright (C) 2015, Xcyber360 Inc. <info@xcyber360.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Xcyber360
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to Xcyber360DB socket ({0})".format(_wdb_socket))
