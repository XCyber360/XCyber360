...
- Test the mapping
    Run the script with a relative path from the `xcyber360` folder to check if a file is mapped.
    ```
    python3 _test_mapping.py framework/xcyber360/agent.py
    ```
    ...
    > **NOTE:** Please use a relative path when trying the testing mode. For instance: `/home/xcyber360/Desktop/git/xcyber360/framework/xcyber360/agent.py` -> `framework/xcyber360/agent.py`
