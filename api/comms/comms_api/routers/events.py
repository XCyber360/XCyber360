...
from xcyber360.core.exception import Xcyber360EngineError, Xcyber360Error, Xcyber360CommsAPIError
...
async def post_stateless_events(request: Request) -> Response:
    ...
    try:
        ...
        raise HTTPError(message=exc.message, status_code=status.HTTP_400_BAD_REQUEST)
    except Xcyber360EngineError as exc:
