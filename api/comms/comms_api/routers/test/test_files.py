...
@pytest.mark.parametrize('exception,message,code', [
    (Xcyber360CommsAPIError(2704), 'Invalid file name, it must not be a directory', 2704),
    (Xcyber360CommsAPIError(2705), 'Invalid file name, it must not contain directories', 2705),
