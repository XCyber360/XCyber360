...
from xcyber360.core.exception import Xcyber360EngineError, Xcyber360Error
from xcyber360.core.indexer.models.events import TaskResult
...
async def test_post_stateless_events_ko():
    ...
    exception = Xcyber360EngineError(2802)
