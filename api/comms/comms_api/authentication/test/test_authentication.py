...
@pytest.mark.asyncio
@patch('comms_api.authentication.authentication.decode_token', side_effect=Xcyber360CommsAPIError(2706))
...
def test_decode_token_ko(mock_get_keypair):
    ...
    with pytest.raises(Xcyber360CommsAPIError, match='Error 2706 - Invalid authentication token'):
