...
from xcyber360.core.indexer.models.commands import Command, Status, Target, TargetType
...
@patch('xcyber360.core.indexer.create_indexer', return_value=INDEXER)
@patch('xcyber360.core.indexer.commands.CommandsManager.update', new_callable=AsyncMock)
