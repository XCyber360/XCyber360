...
import xcyber360.ciscat as ciscat
import xcyber360.rootcheck as rootcheck
import xcyber360.syscheck as syscheck
import xcyber360.syscollector as syscollector
...
def check_experimental_feature_value(func):
    ...
    async def wrapper(*args, **kwargs):
        if not configuration.hardcoded_api_config['experimental_features']:
            raise_if_exc(Xcyber360ResourceNotFound(1122))
        else:
