...
import xcyber360.core.utils as core_utils
import xcyber360.rbac.utils as rbac_utils
from api.util import raise_if_exc
from xcyber360.core.authentication import get_keypair, JWT_ALGORITHM, JWT_ISSUER
from xcyber360.core.cluster.dapi.dapi import DistributedAPI
from xcyber360.rbac.orm import AuthenticationManager, TokenManager, UserRolesManager
from xcyber360.rbac.preprocessor import optimize_resources
...
def decode_token(token: str) -> dict:
    ...
    try:
        ...
        payload = jwt.decode(token, public_key, algorithms=[JWT_ALGORITHM], audience='Xcyber360 API REST')
