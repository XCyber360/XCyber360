...
from xcyber360.core.authentication import get_keypair, JWT_ALGORITHM
...
class Xcyber360AccessLoggerMiddleware(BaseHTTPMiddleware):
    """Middleware to log custom Access messages."""

    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        """Log Xcyber360 access information.
        ...
        if body:
            try:
                ...
                # Related to https://github.com/xcyber360/xcyber360/issues/24060.
