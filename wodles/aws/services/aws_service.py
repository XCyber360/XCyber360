...
class AWSService(xcyber360_integration.Xcyber360AWSDatabase):
    """
    ...
    def __init__(self, reparse: bool, profile: str, iam_role_arn: str,
        ...
        xcyber360_integration.Xcyber360AWSDatabase.__init__(self, db_name=self.db_name, service_name=service_name,
                                                    profile=profile,
