...
def test_aws_sl_subscriber_bucket_initializes_properly(mock_xcyber360_integration, mock_client, mock_sts_client):
...
def test_aws_sl_subscriber_bucket_obtain_logs(mock_xcyber360_integration, mock_sts_client):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sl_subscriber_bucket_obtain_logs_handles_exception(mock_xcyber360_integration,
                                                                                    mock_sts_client):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sl_subscriber_bucket_obtain_logs_with_datetime(mock_xcyber360_integration, mock_sts_client):
...
@patch('xcyber360_integration.Xcyber360Integration.send_msg')
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sl_subscriber_bucket_process_file(mock_xcyber360_integration, mock_sts_client, mock_send, mock_obtain):
...
def test_obtain_logs_processes_different_data_types(bucket_name, log_path, content, expected_logs):
    ...
    with patch('s3_log_handler.xcyber360_integration.Xcyber360Integration.__init__'):
