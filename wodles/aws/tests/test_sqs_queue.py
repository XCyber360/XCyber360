...
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effet=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_initializes_properly(mock_xcyber360_integration, mock_get_sqs_url, mock_message_processor,
    ...
    integration = sqs_queue.AWSSQSQueue(message_processor=mock_message_processor,
                                        ...
                                        **kwargs)
    mock_xcyber360_integration.assert_called_with(integration,
...
def test_aws_sqs_queue_delete_message(mock_xcyber360_integration, mock_sts_client, mock_get_url):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_delete_message_handles_exception_when_deleting_message(mock_xcyber360_integration, mock_sts_client):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_fetch_messages(mock_xcyber360_integration, mock_sts_client, mock_get_url):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_fetch_messages_handles_exception_when_getting_messages(mock_xcyber360_integration, mock_sts_client):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_get_messages(mock_xcyber360_integration, mock_sts_client, mock_fetch):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360Integration.__init__', side_effect=xcyber360_integration.Xcyber360Integration.__init__)
def test_aws_sqs_queue_sync_events(mock_xcyber360_integration, mock_sts_client):
