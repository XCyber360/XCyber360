...
def test_aws_inspector_send_describe_findings(mock_sts_client):
    ...
    with patch('xcyber360_integration.Xcyber360Integration.send_msg') as mock_send_msg, \
...
@patch('xcyber360_integration.Xcyber360AWSDatabase.init_db')
@patch('xcyber360_integration.Xcyber360AWSDatabase.close_db')
