...
def test_aws_guardduty_bucket_check_guardduty_type(mock_xcyber360_aws_integration, mock_sts,
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360AWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_xcyber360_aws_integration, mock_sts):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360AWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_xcyber360_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360AWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_xcyber360_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('xcyber360_integration.Xcyber360Integration.get_sts_client')
@patch('xcyber360_integration.Xcyber360AWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_xcyber360_aws_integration, mock_sts, guardduty_native: bool):
