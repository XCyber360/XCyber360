...
class AWSBucket(xcyber360_integration.Xcyber360AWSDatabase):
    """
    ...
    def __init__(self, db_table_name, bucket, reparse, profile, iam_role_arn,
        ...
        xcyber360_integration.Xcyber360AWSDatabase.__init__(self,
        ...
        def exception_handler(error_txt, error_code):
            if self.skip_on_error:
                ...
                try:
                    ...
                    aws_tools.debug("++ Failed to send message to Xcyber360", 1)
            else:
