...
class AWSS3LogHandler:
    def obtain_logs(self, bucket: str, log_path: str) -> list:
        ...
        -------
        list[dict]
            List of extracted events to send to Xcyber360.
        """
...
class AWSSubscriberBucket(xcyber360_integration.Xcyber360Integration, AWSS3LogHandler):
    ...
    def __init__(self, service_endpoint: str = None, sts_endpoint: str = None, profile: str = None, **kwargs):
        xcyber360_integration.Xcyber360Integration.__init__(self,
                                                    profile=profile,
                                                    service_name='s3',
...
class AWSSLSubscriberBucket(xcyber360_integration.Xcyber360Integration, AWSS3LogHandler):
...
class AWSSecurityHubSubscriberBucket(AWSSubscriberBucket):
    ...
    def _add_event_type_fields(details: dict, event: dict):
        ...
        event : dict
            Destination dictionary to be added to the event sent to Xcyber360.
        """
