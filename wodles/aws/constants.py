...
# URLS
RETRY_CONFIGURATION_URL = 'https://documentation.xcyber360.com/current/amazon/services/prerequisites/' \
                          'considerations.html#Connection-configuration-for-retries'
GUARDDUTY_URL = 'https://documentation.xcyber360.com/current/amazon/services/supported-services/guardduty.html'
SECURITY_LAKE_IAM_ROLE_AUTHENTICATION_URL = 'https://documentation.xcyber360.com/current/cloud-security/amazon/services/' \
...
# MSG HEADERS
XCYBER360_AWS_MESSAGE_HEADER = "1:Xcyber360-AWS:"
