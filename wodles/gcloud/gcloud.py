...
def main():
    ...
    try:
        ...
        if arguments.integration_type == "pubsub":
            ...
            with ThreadPoolExecutor() as executor:
                ...
                # check permissions
                subscriber_client = Xcyber360GCloudSubscriber(credentials_file, project, logger, subscription_id)
                ...
                if messages_per_thread > 0:
                    for _ in range(n_threads - 1):
                        client = Xcyber360GCloudSubscriber(credentials_file, project, logger, subscription_id)
    ...
    except exceptions.Xcyber360IntegrationException as gcloud_exception:
        logging_func = logger.critical if \
            isinstance(gcloud_exception, exceptions.Xcyber360IntegrationInternalError) else \
            logger.error
