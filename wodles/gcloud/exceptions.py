...
class Xcyber360IntegrationException(Exception):
    """Class that represents an exception for the Xcyber360 external integrations.
...
class Xcyber360IntegrationInternalError(Xcyber360IntegrationException):
    """Class that represents a critical exception for the Xcyber360 external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudXcyber360NotRunning',
            'message': 'Xcyber360 must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Xcyber360'
        },
    }

class GCloudError(Xcyber360IntegrationException):
