...
@patch('gcloud.Xcyber360GCloudSubscriber')
...
@patch('pubsub.subscriber.Xcyber360GCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.Xcyber360GCloudSubscriber.process_messages')
