...
import exceptions
import tools
from integration import Xcyber360GCloudIntegration
...
try:
    ...
    raise exceptions.Xcyber360IntegrationException(errcode=1003, package=e.name)


class Xcyber360GCloudBucket(Xcyber360GCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_xcyber360_path(), "wodles/gcloud/gcloud.db")
