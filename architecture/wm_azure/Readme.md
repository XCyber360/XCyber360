...
# Xcyber360 module: Azure architecture
## Index
1. [Purpose](#purpose)
...
Xcyber360 has the ability to obtain and read Microsoft Azure logs through:
- Azure Log Analytics
...
## Sequence diagram
Sequence diagram shows the basic flow of Xcyber360 azure integration based on the configuration provided. Steps are:
