...
# Xcyber360 module: Router PubSub architecture
## Index
- [Xcyber360 module: Router PubSub architecture](#xcyber360-module-router-pubsub-architecture)
  - [Index](#index)
  - [Purpose](#purpose)
...
- 001-sequence-initialize: It explains the xcyber360 module router initialization, construction, use, destruction and stop from the xcyber360 modules daemon perspective.
