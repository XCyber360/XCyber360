...
* ``versions.rb``: versions for Xcyber360 and ELK
...
Installs Kibana packages and configures *kibana.yml*. Also install and configures Xcyber360 Kibana plugin.
...
Check https://documentation.xcyber360.com/current/learning-xcyber360/build-lab/install-elastic-stack.html for more information about 
