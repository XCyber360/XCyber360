...
# Add extra roles and users to Xcyber360 Kibana plugin

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/roles.yml" do
  source "https://raw.githubusercontent.com/xcyber360/xcyber360-documentation/#{node['xcyber360']['minor_version']}/resources/open-distro/elasticsearch/roles/roles.yml"
end

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/roles_mapping.yml" do
  source "https://raw.githubusercontent.com/xcyber360/xcyber360-documentation/#{node['xcyber360']['minor_version']}/resources/open-distro/elasticsearch/roles/roles_mapping.yml"
end

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/internal_users.yml" do
  source "https://raw.githubusercontent.com/xcyber360/xcyber360-documentation/#{node['xcyber360']['minor_version']}/resources/open-distro/elasticsearch/roles/internal_users.yml"
end
