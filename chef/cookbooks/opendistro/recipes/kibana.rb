...
execute 'Install Xcyber360 Kibana plugin' do
  ...
  not_if {
    Dir.exist?("#{node['kibana']['plugins_path']}/xcyber360")
  }
end

# Create Xcyber360-Kibana plugin configuration file
...
template "#{node['kibana']['optimize_path']}/xcyber360/config/xcyber360.yml" do
  ...
  only_if {
    Dir.exist?("#{node['kibana']['optimize_path']}/xcyber360/config")
  }
end
