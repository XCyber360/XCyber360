filebeatout1=$(docker exec multi-node_xcyber360.master_1 sh -c 'filebeat test output')
...
filebeatout2=$(docker exec multi-node_xcyber360.worker_1 sh -c 'filebeat test output')
