...
def unittests(params):
    """ Step that runs the unit tests. It also creates the required folders for Xcyber360 sockets.
...
def valgrind(params):
    """ Runs valgrind over every UT of the project. It also creates the required folders for Xcyber360 sockets.
