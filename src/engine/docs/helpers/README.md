...
Perform a query to xcyber360-db. If it was able to connect to xcyber360-db and run a valid query (no errors)
then map the payload response of xcyber360-db into field. If the field field already exists, then it will be replaced.
