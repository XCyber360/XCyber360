...
from .drivers import ecs, xcyber360
...
def generate(ecs_version: str, modules: list, resource_handler: rs.ResourceHandler) -> Tuple[dict, dict, dict, dict]:
    ...
    for module in modules:
        ...
        module_tree = xcyber360.build_field_tree(fields_definition, module_name)
        ...
        engine_schema['fields'] = {
            **engine_schema['fields'], **xcyber360.to_engine_schema(fields_definition, module_name)}
        print('Success.')
