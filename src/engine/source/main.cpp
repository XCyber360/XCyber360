...
int main(int argc, char* argv[])
{
    ...
    CLI::App_p app =
        std::make_shared<CLI::App>("The Xcyber360 engine analyzes all the events received from agents, remote devices "
                                   "and Xcyber360 integrations. This integrated console application allows to manage "
    ...
    app->set_version_flag("-v, --version", "Xcyber360 Engine v0.0.1");
