...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        MapT(
            ...
            SUCCESS(json::Json {
                R"("(local_source) [] NRN 001 {\"version\":1,\"command\":\"command1\",\"parameters\":{\"extra_args\":[],\"alert\":{\"agent\":{\"id\":\"001\"}}},\"origin\":{\"module\":\"xcyber360-engine\",\"name\":\"node01\"}}")"})),
        MapT(
            R"({})",
            CreateARBuilder,
            {makeValue(R"("command")"), makeValue(R"("ALL")"), makeValue(R"(1)"), makeValue(R"([])")},
            SUCCESS(json::Json {
                R"("(local_source) [] NNS ALL {\"version\":1,\"command\":\"command1\",\"parameters\":{\"extra_args\":[],\"alert\":{}},\"origin\":{\"module\":\"xcyber360-engine\",\"name\":\"node01\"}}")"})),
        MapT(
            R"({})",
            CreateARBuilder,
            {makeValue(R"("command")"), makeValue(R"("001")"), makeValue(R"(1)"), makeValue(R"([])")},
            SUCCESS(json::Json {
                R"("(local_source) [] NNS 001 {\"version\":1,\"command\":\"command1\",\"parameters\":{\"extra_args\":[],\"alert\":{}},\"origin\":{\"module\":\"xcyber360-engine\",\"name\":\"node01\"}}")"})),
        MapT(
            R"({})",
            CreateARBuilder,
            {makeValue(R"("command")"), makeValue(R"("001")"), makeValue(R"(1)"), makeValue(R"(["test-arg","2"])")},
            SUCCESS(json::Json {
                R"("(local_source) [] NNS 001 {\"version\":1,\"command\":\"command1\",\"parameters\":{\"extra_args\":[\"test-arg\",\"2\"],\"alert\":{}},\"origin\":{\"module\":\"xcyber360-engine\",\"name\":\"node01\"}}")"}))),
