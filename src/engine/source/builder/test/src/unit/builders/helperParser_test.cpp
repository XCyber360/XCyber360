...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        TermT(R"(hp($xcyber360.queue) )", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue) ())", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue)==())", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue) AND)", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue)==)", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue)!!)", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue)>)", makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue")}, 16)),
        TermT(R"(hp($xcyber360.queue, ,\ \,) )",
              makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($xcyber360.queue, ,\ \,) ())",
              makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($xcyber360.queue, ,\ \,)==())",
              makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($xcyber360.queue, ,\ \,) AND)",
              makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($xcyber360.queue, ,\ \,)==)",
              makeSuccess<HelperToken>({"hp", Reference("xcyber360.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($xcyber360.queue, ,\ \,)!!)",
