...
// TODO: move the xcyber360Request to a common path such as "utils"
...
constexpr const char* MODULE_NAME {"xcyber360-engine"};
...
MapOp CreateARBuilder(const std::vector<OpArg>& opArgs, const std::shared_ptr<const IBuildCtx>& buildCtx)
{
            ...
            base::ConstEvent event) -> MapResult
    {
        ...
        auto payload = base::utils::xcyber360Protocol::Xcyber360Request::create(cmd, ar::ORIGIN_NAME, jsonParams);
