...
public:
     ...
     */
    const std::string& getTemplateFilePath() const { return m_templateFilePath; }

    /**
     * @brief Gets the events file path.
     * @return Events file path.
     */
    const std::string& getEventsFilePath() const { return m_eventsFilePath; }

    /**
     * @brief Gets the auto generated flag.
     * @return Auto generated flag.
     */
    bool getAutoGenerated() const { return m_autoGenerated.compare("true") == 0; }
    ...
    uint64_t getNumberOfEvents() const { return std::stoull(m_numberOfEvents); }

    /**
     * @brief Gets the wait time.
     * @return Wait time.
     */
    uint64_t getWaitTime() const { return std::stoull(m_waitTime); }
