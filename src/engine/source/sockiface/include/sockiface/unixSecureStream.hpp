...
/*
    ...
    See: https://documentation.xcyber360.com/current/development/message-format.html
*/
 ...
 * The messages are handled by following the Xcyber360 TCP protocol.
 */
