...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ParseT(
            SUCCESS,
            "https://demo.xcyber360.com:8080/user.php?name=pepe&pass=123#login",
            j(fmt::format(
                R"({{"{}": {{"original":"https://demo.xcyber360.com:8080/user.php?name=pepe&pass=123#login","domain":"demo.xcyber360.com","path":"/user.php","scheme":"https","query":"name=pepe&pass=123","port":"8080","fragment":"login"}}}})",
                TARGET.substr(1))),
            61,
            getUriParser,
            {NAME, TARGET, {""}, {}}),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(ParseT(SUCCESS,
                             R"(www.xcyber360.com)",
                             j(fmt::format(R"({{"{}": "www.xcyber360.com"}})", TARGET.substr(1))),
                             13,
                             getFQDNParser,
                             {NAME, TARGET, {}, {}}),
                      ParseT(SUCCESS,
                             ...
                             getFQDNParser,
                             {NAME, TARGET, {}, {}}),
                      ParseT(FAILURE, R"(..xcyber360.com)", {}, 0, getFQDNParser, {NAME, TARGET, {}, {}}),
                      ParseT(SUCCESS,
                             R"(www.xcyber360.com.   )",
                             j(fmt::format(R"({{"{}": "www.xcyber360.com."}})", TARGET.substr(1))),
                             14,
