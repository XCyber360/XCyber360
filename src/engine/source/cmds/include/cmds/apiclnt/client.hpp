...
public:
    ...
    base::utils::xcyber360Protocol::Xcyber360Response send(const base::utils::xcyber360Protocol::Xcyber360Request& request)
    {
        ...
        // Parse answer
        base::utils::xcyber360Protocol::Xcyber360Response parsedResponse;
        try
        {
            parsedResponse = base::utils::xcyber360Protocol::Xcyber360Response::fromStr(response);
        }
