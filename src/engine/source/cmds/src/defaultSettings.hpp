...
constexpr auto ENGINE_SRV_EVENT_SOCK = "/run/xcyber360-server/queue";
...
constexpr auto ENGINE_SRV_API_SOCK = "/run/xcyber360-server/engine-api.socket";
...
constexpr auto ENGINE_SRV_SOCK = "/run/xcyber360-server/engine.socket";

constexpr auto ENGINE_INDEXER_CONNECTOR_QUEUE = "/var/lib/xcyber360-server/indexer-connector/";

// Store module
constexpr auto ENGINE_DEFAULT_POLICY = "policy/xcyber360/0";
constexpr auto ENGINE_STORE_PATH = "/var/lib/xcyber360-server/engine/store";
constexpr auto ENGINE_STORE_PATH_ENV = "WZE_STORE_PATH";

// KVDB module
constexpr auto ENGINE_KVDB_PATH = "/var/lib/xcyber360-server/engine/kvdb/";
constexpr auto ENGINE_KVDB_PATH_ENV = "WZE_KVDB_PATH";

// TZDB
constexpr auto ENGINE_TZDB_PATH = "/var/lib/xcyber360-server/engine/tzdb";
