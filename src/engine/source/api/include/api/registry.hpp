...
/**
 * @brief Alias for Xcyber360Response and Xcyber360Request
 */
...
/**
 * @brief Represent a handler function, which receives a Xcyber360Request and returns a Xcyber360Response
 */
 ...
 *
 * This class is used as registry of API xcyber360 internal handlers.
