...
auto constexpr INTEGRATION = R"({
    ...
    "name": "integration/xcyber360-core/0"
})";

auto constexpr POLICY = R"({
    "name": "policy/xcyber360/0",
    "integrations": [
        "integration/xcyber360-core/0"
    ]
})";

auto constexpr XCYBER360_LOGPAR_TYPES = R"({
    "name": "schema/xcyber360-logpar-types/0",
    "fields": {
        "@timestamp": "date",
        ...
        "xcyber360.queue": "long",
        "xcyber360.location": "text",
        "xcyber360.message": "text",
        "xcyber360.origin": "keyword",
        "xcyber360.registered_ip": "keyword",
        "xcyber360.source": "keyword",
        "url": "url",
