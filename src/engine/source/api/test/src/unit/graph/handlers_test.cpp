...
constexpr auto JSON_INTEGRATION {"integration/xcyber360-core/0"};
constexpr auto JSON_POLICY {"policy/xcyber360/0"};
constexpr auto JSON_SCHEMA {"schema/xcyber360-logpar-types/0"};
...
TEST_P(GraphGetCommand, ParameterEvaluation)
{
    ...
    EXPECT_CALL(*m_spMockStore, readInternalDoc(testing::Eq(base::Name {JSON_SCHEMA})))
        .WillRepeatedly(::testing::Return(storeReadDocResp(store::Doc {XCYBER360_LOGPAR_TYPES})));
    ...
    base::utils::xcyber360Protocol::Xcyber360Request request;
