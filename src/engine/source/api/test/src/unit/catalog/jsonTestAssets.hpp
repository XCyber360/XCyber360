...
constexpr auto schema_malformed = R"(
{
  ...
  "$id": "xcyber360-decoders.json",
  "title": "Malformed Schema",
  "description": "Validate Xcyber360 decoder specification",
...
constexpr auto json_schema_decoder = R"(
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "xcyber360-decoders.json",
  "title": "Schema for Xcyber360 decoders specification",
  "description": "Validate Xcyber360 decoder specification",
  "type": "object",
  "additionalProperties": false,
  "required": [
