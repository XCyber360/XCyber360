...
const uint32_t TableStruct_graph_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Request, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Request, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Request, _impl_.policy_),
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Request, _impl_.type_),
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Response, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Response, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Response, _impl_.status_),
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Response, _impl_.error_),
  PROTOBUF_FIELD_OFFSET(::com::xcyber360::api::engine::graph::GraphGet_Response, _impl_.content_),
  ~0u,
  0,
  1,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, -1, sizeof(::com::xcyber360::api::engine::graph::GraphGet_Request)},
  { 10, 19, -1, sizeof(::com::xcyber360::api::engine::graph::GraphGet_Response)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::com::xcyber360::api::engine::graph::_GraphGet_Request_default_instance_._instance,
  &::com::xcyber360::api::engine::graph::_GraphGet_Response_default_instance_._instance,
};

const char descriptor_table_protodef_graph_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013graph.proto\022\032com.xcyber360.api.engine.grap"
  ...
  "\006status\030\001 \001(\0162\".com.xcyber360.api.engine.Ret"
...
GraphGet_Request::GraphGet_Request(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:com.xcyber360.api.engine.graph.GraphGet_Request)
}
GraphGet_Request::GraphGet_Request(const GraphGet_Request& from)
  ...
  // @@protoc_insertion_point(copy_constructor:com.xcyber360.api.engine.graph.GraphGet_Request)
}
...
GraphGet_Request::~GraphGet_Request() {
  // @@protoc_insertion_point(destructor:com.xcyber360.api.engine.graph.GraphGet_Request)
...
// @@protoc_insertion_point(message_clear_start:com.xcyber360.api.engine.graph.GraphGet_Request)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.xcyber360.api.engine.graph.GraphGet_Request.policy"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.xcyber360.api.engine.graph.GraphGet_Request.type"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* GraphGet_Request::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:com.xcyber360.api.engine.graph.GraphGet_Request)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (_internal_has_policy()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "com.xcyber360.api.engine.graph.GraphGet_Request.policy");
  ...
  if (_internal_has_type()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "com.xcyber360.api.engine.graph.GraphGet_Request.type");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.xcyber360.api.engine.graph.GraphGet_Request)
  return target;
}

size_t GraphGet_Request::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:com.xcyber360.api.engine.graph.GraphGet_Request)
  size_t total_size = 0;
...
void GraphGet_Request::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:com.xcyber360.api.engine.graph.GraphGet_Request)
...
// @@protoc_insertion_point(class_specific_copy_from_start:com.xcyber360.api.engine.graph.GraphGet_Request)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
GraphGet_Response::GraphGet_Response(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:com.xcyber360.api.engine.graph.GraphGet_Response)
}
GraphGet_Response::GraphGet_Response(const GraphGet_Response& from)
  ...
  // @@protoc_insertion_point(copy_constructor:com.xcyber360.api.engine.graph.GraphGet_Response)
}
...
GraphGet_Response::~GraphGet_Response() {
  // @@protoc_insertion_point(destructor:com.xcyber360.api.engine.graph.GraphGet_Response)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:com.xcyber360.api.engine.graph.GraphGet_Response)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.xcyber360.api.engine.graph.GraphGet_Response.error"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "com.xcyber360.api.engine.graph.GraphGet_Response.content"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* GraphGet_Response::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.xcyber360.api.engine.graph.GraphGet_Response)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (_internal_has_error()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "com.xcyber360.api.engine.graph.GraphGet_Response.error");
    target = stream->WriteStringMaybeAliased(
  ...
  if (_internal_has_content()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "com.xcyber360.api.engine.graph.GraphGet_Response.content");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.xcyber360.api.engine.graph.GraphGet_Response)
  return target;
}

size_t GraphGet_Response::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:com.xcyber360.api.engine.graph.GraphGet_Response)
  size_t total_size = 0;
...
void GraphGet_Response::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:com.xcyber360.api.engine.graph.GraphGet_Response)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:com.xcyber360.api.engine.graph.GraphGet_Response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::com::xcyber360::api::engine::graph::GraphGet_Request*
Arena::CreateMaybeMessage< ::com::xcyber360::api::engine::graph::GraphGet_Request >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::xcyber360::api::engine::graph::GraphGet_Request >(arena);
}
template<> PROTOBUF_NOINLINE ::com::xcyber360::api::engine::graph::GraphGet_Response*
Arena::CreateMaybeMessage< ::com::xcyber360::api::engine::graph::GraphGet_Response >(Arena* arena) {
  return Arena::CreateMessageInternal< ::com::xcyber360::api::engine::graph::GraphGet_Response >(arena);
}
