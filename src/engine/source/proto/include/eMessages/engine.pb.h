...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::xcyber360::api::engine::GenericStatus_Response* Arena::CreateMaybeMessage<::com::xcyber360::api::engine::GenericStatus_Response>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace xcyber360 {
namespace api {
...
class GenericStatus_Response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.xcyber360.api.engine.GenericStatus_Response) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.xcyber360.api.engine.GenericStatus_Response";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:com.xcyber360.api.engine.GenericStatus_Response)
 private:
  class _Internal;
...
inline ::com::xcyber360::api::engine::ReturnStatus GenericStatus_Response::_internal_status() const {
  return static_cast< ::com::xcyber360::api::engine::ReturnStatus >(_impl_.status_);
}
inline ::com::xcyber360::api::engine::ReturnStatus GenericStatus_Response::status() const {
  // @@protoc_insertion_point(field_get:com.xcyber360.api.engine.GenericStatus_Response.status)
  return _internal_status();
}
inline void GenericStatus_Response::_internal_set_status(::com::xcyber360::api::engine::ReturnStatus value) {
  
  _impl_.status_ = value;
}
inline void GenericStatus_Response::set_status(::com::xcyber360::api::engine::ReturnStatus value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:com.xcyber360.api.engine.GenericStatus_Response.status)
}
...
inline const std::string& GenericStatus_Response::error() const {
  // @@protoc_insertion_point(field_get:com.xcyber360.api.engine.GenericStatus_Response.error)
...
void GenericStatus_Response::set_error(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.xcyber360.api.engine.GenericStatus_Response.error)
}
inline std::string* GenericStatus_Response::mutable_error() {
  std::string* _s = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:com.xcyber360.api.engine.GenericStatus_Response.error)
  return _s;
}
...
inline std::string* GenericStatus_Response::release_error() {
  // @@protoc_insertion_point(field_release:com.xcyber360.api.engine.GenericStatus_Response.error)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:com.xcyber360.api.engine.GenericStatus_Response.error)
}
...
template <> struct is_proto_enum< ::com::xcyber360::api::engine::ReturnStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::xcyber360::api::engine::ReturnStatus>() {
  return ::com::xcyber360::api::engine::ReturnStatus_descriptor();
}
