/*
 * Xcyber360 Vulnerability scanner - Scan Orchestrator
...
public:
     ...
     */
    bool isFull() const { return m_map.size() == m_capacity; }
     ...
     */
    bool isHit(const KeyType& key) const { return m_map.find(key) != m_map.end(); }
