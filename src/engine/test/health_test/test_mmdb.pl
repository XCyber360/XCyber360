...
my %address_for_test = (
    '1.2.3.4/32' => {
        city  => { names => {en => 'Xcyber360 city' }},
        continent  => {code => 'WC', names => {en => 'Xcyber360 Continent' }},
        country  => {iso_code => 'WCtry', names => {en => 'Xcyber360 Country' }},
        location  => {latitude => 41.7776, longitude => 88.4293, time_zone => 'Xcyber360/Timezone'},
        postal  => {code => '7777'},
        autonomous_system_number => 1234,
        autonomous_system_organization => 'Xcyber360 Organization',
    }
);
