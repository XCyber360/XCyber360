Feature: Manage Geolocation Databases
    As a user of the Xcyber360 geo manager API
    ...
    Scenario: Remotely upsert a geolocation database
        When I send a request to remotely upsert a database with path to "testdb-city.mmdb", type "city", db url "https://github.com/xcyber360/xcyber360/raw/master/src/engine/test/integration_tests/geo/data/base.mmdb" and hash url "https://github.com/xcyber360/xcyber360/raw/master/src/engine/test/integration_tests/geo/data/base.md5"
        Then the response should be a "success"
        And the database list "should" include "testdb-city.mmdb"
