...
public:
    ...
    {
        std::cout << "\nUsage: xcyber360-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./xcyber360-keystore -f indexer -k username -v admin\n"
                  << "\n\t./xcyber360-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./xcyber360-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./xcyber360-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./xcyber360-keystore -f indexer -k password\n"
                  << std::endl;
    }
