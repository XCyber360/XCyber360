...
The Content Manager is a module that is in charge of obtaining the Xcyber360 Content from an external repository, as well as maintaining the periodic updates that the manager will obtain.
...
- `configData`: Configuration data to create the orchestration of the module.
  + `consumerName`: Name of the Content Manager caller (e.g. `Xcyber360 VulnerabilityScanner`). Used to set the "User-Agent" HTTP header.
...
```json
{
    ...
    "configData":
    {
        ...
        "url": "https://cti.xcyber360.com/api/v1/catalog/contexts/test_context/consumers/test_consumer",
...
[DEBUG_VERBOSE]: Downloading offsets from: 'https://cti.xcyber360.com/api/v1/catalog/contexts/vd_1.0.0/consumers/vd_4.8.0//changes?from_offset=228000&to_offset=229000'
[DEBUG_VERBOSE]: Downloading offsets from: 'https://cti.xcyber360.com/api/v1/catalog/contexts/vd_1.0.0/consumers/vd_4.8.0//changes?from_offset=229000&to_offset=230000'
[DEBUG_VERBOSE]: Downloading offsets from: 'https://cti.xcyber360.com/api/v1/catalog/contexts/vd_1.0.0/consumers/vd_4.8.0//changes?from_offset=230000&to_offset=230577'
...
```json
{
    ...
    "configData":
    {
        ...
        "url": "https://cti.xcyber360.com/cti-snapshots/store/contexts/test_context/consumers/test_consumer/1000_2000.zip",
        "outputFolder": "/tmp/output_folder"
    }
}
```
