...
default_count='10000'
default_index_name='xcyber360-integrations'
...
def generate_document(params):
  ...
  # https://github.com/xcyber360/xcyber360/blob/11334-dev-new-xcyber360-engine/src/engine/ruleset/schemas/xcyber360-asset.json
  data = {
    "ecs": {"version": "1.7.0"},
