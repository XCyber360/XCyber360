/*
 * Xcyber360 app - Docker sample data
...
module.exports.actorAttributesImage = ["xcyber360/xcyber360:3.12.0-7.6.1", "docker.elastic.co/elasticsearch/elasticsearch:7.6.2", "docker.elastic.co/kibana/kibana:7.6.2", "nginx:latest"];
...
module.exports.dataDocker = [{
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository xcyber360/xcyber360 pulled",
      id: "87932",
      firedtimes: 1,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "xcyber360/xcyber360:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "xcyber360/xcyber360:3.9.2_7.1.1",
          Attributes: {
            name: "xcyber360/xcyber360"
          }
        },
        scope: "local",
        time: "1563354346",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository xcyber360/xcyber360-elasticsearch pulled",
      id: "87932",
      firedtimes: 2,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "xcyber360/xcyber360-elasticsearch:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "xcyber360/xcyber360-elasticsearch:3.9.2_7.1.1",
          Attributes: {
            ...
            name: "xcyber360/xcyber360-elasticsearch",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository xcyber360/xcyber360-kibana pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "xcyber360/xcyber360-kibana:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "xcyber360/xcyber360-kibana:3.9.2_7.1.1",
          Attributes: {
            license: "Elastic License",
            name: "xcyber360/xcyber360-kibana",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository xcyber360/xcyber360-nginx pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "xcyber360/xcyber360-nginx:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "xcyber360/xcyber360-nginx:3.9.2_7.1.1",
          Attributes: {
            maintainer: "NGINX Docker Maintainers <docker-maint@nginx.com>",
            name: "xcyber360/xcyber360-nginx"
          }
        }
      },
      scope: "local",
