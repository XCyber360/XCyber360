...
# Installation script for Xcyber360
...
Install()
{
    ...
    # Calling the init script to start Xcyber360 during boot
    runInit
    runinit_value=$?
}
...
main()
{
    ...
    . ./src/init/init.sh
    . ./src/init/xcyber360/xcyber360.sh
    ...
    # Initial message
    echo " $NAME $VERSION (Rev. $REVISION) ${installscript} - https://www.xcyber360.com"
    ...
    echo ""
    echo " - ${tostart}:"
    echo "      $INSTALLDIR/bin/xcyber360-control start"
    echo ""
    echo " - ${tostop}:"
    echo "      $INSTALLDIR/bin/xcyber360-control stop"
    echo ""
    echo ""
    ...
    echo ""
    echo "   ${moreinfo}"
    echo "   https://documentation.xcyber360.com/"
    echo ""
